...
function enforceCredentialFilePermissions(path) {
    ...
    try {
        ...
        if (mode & 0o077) {
            ...
            console.error(`[gmgn-cli] Warning: ${path} was accessible to other users (mode ${mode.toString(8)}). ` +
...
loadDotenv();
let _config = null;
const PRIVATE_KEY_REQUIRED_MSG = "GMGN_PRIVATE_KEY is required for critical-auth commands (swap, order, and follow-wallet commands)";
