...
export class OpenApiClient {
    ...
    async searchMarket(query, extra = {}) {
...
function buildTrenchesBody(chain, types, platforms, limit, filters) {
    ...
    if (quote_address_type.length)
        section.quote_address_type = quote_address_type;
