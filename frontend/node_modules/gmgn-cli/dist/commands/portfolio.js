...
export function registerPortfolioCommands(program) {
    ...
    portfolio
        ...
        const extra = {};
        if (opts.token)
            extra["token_address"] = opts.token;
        if (opts.limit != null)
            extra["limit"] = opts.limit;
        if (opts.cursor)
            extra["cursor"] = opts.cursor;
    ...
    portfolio
        ...
        if (opts.migrateState)
            extra["migrate_state"] = opts.migrateState;
        const client = new OpenApiClient(getConfig());
