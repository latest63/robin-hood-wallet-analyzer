...
import { A as safeJsonStringify, C as sn$2, D as k$4, E as import_browser, F as require_cjs, M as i$1, N as r, O as y$4, P as IEvents, S as Qo, T as E$5, _ as require_cjs$2, a as isJsonRpcRequest, b as Po$2, c as formatJsonRpcError, d as getBigIntRpcId, f as payloadId, g as esm_default, h as allocUnsafe, i as isJsonRpcError, j as createStorage, k as safeJsonParse, l as formatJsonRpcRequest, m as fromString, n as f$3, o as isJsonRpcResponse, p as toString, r as o, s as isJsonRpcResult, t as f$4, u as formatJsonRpcResult, v as require_cjs$1, w as A$3, x as Qe$3, y as detect } from "./index.es-DBmgzwtm.js";
...
async function recoverPublicKey({ hash, signature }) {
	...
	const { secp256k1 } = await import("./secp256k1-YDv82UV1.js");
	return `0x${(() => {
...
var es$1 = Object.getOwnPropertyDescriptors;
...
var Us = class {
	constructor(e) {
		this.blockLen = 16, this.outputLen = 16, this.buffer = /* @__PURE__ */ new Uint8Array(16), this.r = /* @__PURE__ */ new Uint16Array(10), this.h = /* @__PURE__ */ new Uint16Array(10), this.pad = /* @__PURE__ */ new Uint16Array(8), this.pos = 0, this.finished = !1, e = ze$2(e), tt$2(e, 32);
...
function Cc(t, e) {
	const r = Vs$1(Qt$2, fn$1.getSharedSecret(fromString(t, G$2), fromString(e, G$2)), void 0, void 0, hn$1);
...
//#endregion
//#region node_modules/@walletconnect/core/node_modules/@walletconnect/keyvaluestorage/dist/index.es.js
var x$1 = "idb-keyval";
var z$2 = (i = {}) => {
...
var D$2 = "WALLET_CONNECT_V2_INDEXED_DB";
var E$4 = "keyvaluestorage";
var _$1 = class {
	constructor() {
...
var O$3 = async (i, t, e) => {
	...
	await t.setItem(n, y$3), e(t), j$2(i, m);
};
var j$2 = async (i, t) => {
...
var b$3 = (e, s, r) => s in e ? p$2(e, s, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: r
}) : e[s] = r;
var v$3 = (e, s, r) => b$3(e, typeof s != "symbol" ? s + "" : s, r);
...
var P$1 = ({ name: r, prefix: e, bitsPerChar: t, alphabet: i }) => Ee$2({
	prefix: e,
	name: r,
	encode(s) {
		return pr(s, i, t);
...
var W$2 = (r, e, t) => Rn(r, typeof e != "symbol" ? e + "" : e, t);
var Di = class {
	constructor(e, t) {
...
var S$2 = (r, e, t) => xn(r, typeof e != "symbol" ? e + "" : e, t);
var vi = class {
	constructor(e, t, i) {
...
var V$2 = (r, e, t) => qe$1(r, typeof e != "symbol" ? e + "" : e, t);
...
var f$1 = (r, e, t) => We$2(r, typeof e != "symbol" ? e + "" : e, t);
...
var Si = class extends d$1 {
	constructor(e) {
		...
		}), this.core = e.core, this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? E$5(e.logger, this.name) : (0, import_browser.default)(k$4({ level: e.logger || "error" })), this.messages = new _i(this.logger, e.core), this.subscriber = new Ti(this, this.logger), this.publisher = new qn(this, this.logger), this.relayUrl = e?.relayUrl || "wss://relay.walletconnect.org", this.projectId = e.projectId, ei$1() ? this.packageName = ri$1() : ni$1() && (this.bundleId = ri$1()), this.provider = {};
	}
	async init() {
...
var z$1 = (r, e, t) => Xe$1(r, typeof e != "symbol" ? e + "" : e, t);
...
var p$1 = (r, e, t) => Lo(r, typeof e != "symbol" ? e + "" : e, t);
var Li = class {
	constructor(e, t) {
...
var A$2 = (r, e, t) => Fo(r, typeof e != "symbol" ? e + "" : e, t);
...
var w$1 = (r, e, t) => Ko(r, typeof e != "symbol" ? e + "" : e, t);
...
var E$3 = (r, e, t) => Ze$2(r, typeof e != "symbol" ? e + "" : e, t);
var Bi = class extends R$3 {
	constructor(e, t, i = !0) {
		...
		}), E$3(this, "getAppDomain", () => Pn$1().url), this.logger = E$5(t, this.context), this.telemetryEnabled = i, i ? this.restore().then(async () => {
...
var Xo = class Te$1 extends h$1 {
	constructor(e) {
		...
		const s = k$4({
			...
			name: he$1
		}), { logger: n, chunkLoggerController: o } = A$3({
			opts: s,
		...
		}), this.logger = E$5(n, this.name), this.heartbeat = new i$1(), this.crypto = new vi(this, this.logger, e?.keychain), this.history = new ki(this, this.logger), this.expirer = new ji(this, this.logger), this.storage = e != null && e.storage ? e.storage : new h$2(qi(qi({}, It$1), e?.storageOptions)), this.relayer = new Si({
			core: this,
			logger: this.logger,
			relayUrl: this.relayUrl,
			projectId: this.projectId
...
var E$2 = (S, n, e) => Ms(S, typeof n != "symbol" ? n + "" : n, e);
...
var U$1 = `wc@2:universal_provider:`;
var st$1 = "https://rpc.walletconnect.org/v1/";
var I$1 = "generic";
var jt = `${st$1}bundler`;
...
var A$1 = (s, t, e) => X$1(s, typeof t != "symbol" ? t + "" : t, e);
var Ie = class {
	constructor(t) {
...
var C$1 = (s, t, e) => Oe(s, typeof t != "symbol" ? t + "" : t, e);
var Ae = class {
	constructor(t) {
...
var H$1 = (s, t, e) => He(s, typeof t != "symbol" ? t + "" : t, e);
var Ee = class {
	constructor(t) {
...
var E$1 = (s, t, e) => Se(s, typeof t != "symbol" ? t + "" : t, e);
var De = class {
	constructor(t) {
...
var S$1 = (s, t, e) => Ue(s, typeof t != "symbol" ? t + "" : t, e);
var Fe = class {
	constructor(t) {
...
var D$1 = (s, t, e) => Me(s, typeof t != "symbol" ? t + "" : t, e);
var xe = class {
	constructor(t) {
...
var q$1 = (s, t, e) => Ge(s, typeof t != "symbol" ? t + "" : t, e);
var Je = class {
	constructor(t) {
...
var j$1 = (s, t, e) => ke(s, typeof t != "symbol" ? t + "" : t, e);
var We = class {
	constructor(t) {
...
var R$1 = (s, t, e) => Ve(s, typeof t != "symbol" ? t + "" : t, e);
var Xe = class {
	constructor(t) {
...
var Q$1 = (s, t) => Qe(s, Ze(t));
var l = (s, t, e) => Y$1(s, typeof t != "symbol" ? t + "" : t, e);
var es = class B$1 {
	constructor(t) {
		l(this, "client"), l(this, "namespaces"), l(this, "optionalNamespaces"), l(this, "sessionProperties"), l(this, "scopedProperties"), l(this, "events", new import_events.default()), l(this, "rpcProviders", {}), l(this, "session"), l(this, "providerOpts"), l(this, "logger"), l(this, "uri"), l(this, "disableProviderPing", !1), this.providerOpts = t, this.logger = typeof t?.logger < "u" && typeof t?.logger != "string" ? t.logger : (0, import_browser.default)(k$4({ level: t?.logger || et$1 })), this.disableProviderPing = t?.disableProviderPing || !1;
	}
	static async init(t) {
		const e = new B$1(t);
		return await e.initialize(), e;
	...
	registerEventListeners() {
		...
		this.client.on("session_ping", (t) => {
			...
			this.session = Q$1(x({}, r), { namespaces: a }), this.onSessionUpdate(), this.events.emit("session_update", {
				topic: t,
				params: e
			});
...
var U = "https://rpc.walletconnect.org/v1/";
var f = ["eth_sendTransaction", "personal_sign"];
var A = [
	"eth_accounts",
	"eth_requestAccounts",
...
var D = async () => {
	const { createAppKit: s } = await import("./core-QYfwtbPh.js");
	return s;
};
...
//#endregion
export { Y as EthereumProvider, rotr as a, abytes as c, aoutput as d, C$4 as f, randomBytes as i, aexists as l, concatBytes as n, toBytes as o, concat as p, createView as r, wrapConstructor as s, Hash as t, ahash as u };
