import { $ as stringify, At as InvalidStorageKeySizeError$1, B as from$8, C as from$7, D as fromString$1, E as fromNumber, Et as InvalidLegacyVError, F as toNumber, Gt as InvalidChainIdError$1, H as fromString, I as toString, L as trimLeft, M as size, N as slice, O as isEqual$1, Ot as InvalidSerializedTransactionError, P as toBigInt, Q as validate, R as validate$1, S as concat$1, T as fromBytes, U as isEqual, V as fromHex$1, Vt as parseAccount, W as padLeft, a as serializeStateOverride, b as InvalidLengthError, et as BaseError, i as maxUint256, j as random, jt as InvalidYParityError, k as padLeft$1, kt as InvalidSerializedTransactionTypeError, l as extract, n as assertRequest, o as defineTransactionRequest, p as isAddressEqual, r as maxUint16, rn as createCursor, s as formatTransactionRequest$1, u as getCallError, x as assert$3, z as concat } from "./call-C6GuDgqH.js";
import { C as isAddress, T as InvalidAddressError, _ as concatHex, b as sliceHex, t as encodeFunctionData, v as slice$1, w as keccak256 } from "./encodeFunctionData-35L66rl1.js";
import { A as isHex, C as RlpTrailingBytesError, O as BaseError$1, S as RlpListBoundaryExceededError, T as padHex, _ as trim, a as toBytes$1, b as InvalidHexValueError, c as numberToHex$1, h as hexToNumber$1, k as size$1, p as hexToBigInt, r as hexToBytes, s as bytesToHex, u as toHex$1, w as pad, x as RlpDepthLimitExceededError } from "./stringify-BgI-TJVg.js";
import { $ as defineTransactionReceipt, At as readContract, B as fromHex$3, C as toRpc$6, Ct as defineBlock, D as createCurve, E as secp256k1, Et as formatTransaction$1, F as from$10, G as validate$2, H as toHex$2, I as fromPublicKey, J as sha512, K as sha256, L as isEqual$2, M as create, N as assert$4, O as Field, P as checksum, Q as getCode, R as validate$3, S as toHex$3, T as yParityToV, Tt as defineTransaction, U as keccak256$1, V as toBytes$2, W as sha256$1, X as parseEventLogs, _ as extract$1, _t as blobsToCommitments, an as getAction, b as fromRpc$7, d as getSelector, dt as EmptyBlobError, et as formatTransactionReceipt$1, ft as InvalidVersionedHashSizeError, g as assert$5, gt as blobsToProofs, h as toRpcList$1, ht as sha256$2, i as AccountNotFoundError, kt as toRlp, lt as getTransactionType, m as fromRpcList$1, mt as commitmentsToVersionedHashes, n as sendTransaction, nt as formatLog, o as verifyHash$1, p as getTransaction, pt as InvalidVersionedHashVersionError, q as sha384, t as writeContract, ut as toBlobSidecars, v as from$11, w as toTuple$3, x as fromTuple$3, y as fromHex$2, z as from$9 } from "./writeContract-CiiDKfcK.js";
import { f as TipAboveFeeCapError$1, i as FeeCapTooHighError$1 } from "./createBatchScheduler-D-fKlVQ-.js";
...
function assertTransactionEIP4844(transaction) {
	...
	if (blobVersionedHashes) {
		...
		for (const hash of blobVersionedHashes) {
			...
			const version = hexToNumber$1(slice$1(hash, 0, 1));
...
function assertTransactionEIP1559(transaction) {
	...
	if (maxFeePerGas && maxFeePerGas > maxUint256) throw new FeeCapTooHighError$1({ maxFeePerGas });
	if (maxPriorityFeePerGas && maxFeePerGas && maxPriorityFeePerGas > maxFeePerGas) throw new TipAboveFeeCapError$1({
		maxFeePerGas,
...
function assertTransactionEIP2930(transaction) {
	...
	if (gasPrice && gasPrice > maxUint256) throw new FeeCapTooHighError$1({ maxFeePerGas: gasPrice });
}
function assertTransactionLegacy(transaction) {
	const { chainId, maxPriorityFeePerGas, gasPrice, maxFeePerGas, to } = transaction;
	if (to && !isAddress(to)) throw new InvalidAddressError({ address: to });
	if (typeof chainId !== "undefined" && chainId <= 0) throw new InvalidChainIdError$1({ chainId });
...
function serializeAccessList(accessList) {
	...
	for (let i = 0; i < accessList.length; i++) {
		...
		for (let j = 0; j < storageKeys.length; j++) if (storageKeys[j].length - 2 !== 64) throw new InvalidStorageKeySizeError$1({ storageKey: storageKeys[j] });
...
function serializeTransaction$4(transaction, signature) {
...
function toYParitySignatureArray(transaction, signature_) {
	...
	return [
		(() => {
			if (typeof yParity === "number") return yParity ? numberToHex$1(1) : "0x";
			if (v === 0n) return "0x";
			if (v === 1n) return numberToHex$1(1);
...
function fromRlp(value, to = "hex") {
	...
	const cursor = createCursor(bytes, { recursiveReadLimit: Number.POSITIVE_INFINITY });
	const result = fromRlpCursor(cursor, to);
	if (cursor.position < cursor.bytes.length) throw new RlpTrailingBytesError({ count: cursor.bytes.length - cursor.position });
	return result;
}
function fromRlpCursor(cursor, to = "hex", recursiveDepth = 0) {
	if (recursiveDepth >= rlpDepthLimit) throw new RlpDepthLimitExceededError({ limit: rlpDepthLimit });
	...
	return readList$1(cursor, readLength$1(cursor, prefix, 192), to, recursiveDepth + 1);
}
...
function readList$1(cursor, length, to, recursiveDepth) {
	const position = cursor.position;
	const value = [];
	while (cursor.position - position < length) value.push(fromRlpCursor(cursor, to, recursiveDepth));
	if (cursor.position - position !== length) throw new RlpListBoundaryExceededError({
...
function to(value, to) {
	...
	return decodeRlpCursor(create(bytes, { recursiveReadLimit: Number.POSITIVE_INFINITY }), to_);
}
/** @internal */
/** @internal */
function decodeRlpCursor(cursor, to = "Hex") {
	if (cursor.bytes.length === 0) return to === "Hex" ? fromBytes(cursor.bytes) : cursor.bytes;
	const prefix = cursor.readByte();
	if (prefix < 128) cursor.decrementPosition(1);
	if (prefix < 192) {
		const length = readLength(cursor, prefix, 128);
		const bytes = cursor.readBytes(length);
		return to === "Hex" ? fromBytes(bytes) : bytes;
	}
...
function recoverPublicKey(options) {
	...
	const point = new secp256k1.Signature(BigInt(r), BigInt(s)).addRecoveryBit(yParity).recoverPublicKey(from$7(payload).substring(2));
	return from$9(point);
}
/**
...
function verify$4(options) {
	...
	if (options.address) return isEqual$2(options.address, recoverAddress({
		payload,
		signature: options.signature
	}));
	return secp256k1.verify(options.signature, from$8(payload), toBytes$2(options.publicKey), ...hash ? [{
		prehash: true,
		lowS: true
	}] : []);
}
fromString("ox.secp256k1.fromSeed.v1");
//#endregion
...
function getSerializedTransactionType(serializedTransaction) {
	...
	if (serializedType !== "0x" && hexToNumber$1(serializedType) >= 192) return "legacy";
...
function parseTransactionEIP7702(serializedTransaction) {
	...
	if (isHex(nonce)) transaction.nonce = nonce === "0x" ? 0 : hexToNumber$1(nonce);
...
function parseAuthorizationList(serializedAuthorizationList) {
	...
	for (let i = 0; i < serializedAuthorizationList.length; i++) {
		...
		authorizationList.push({
			address,
			chainId: chainId === "0x" ? 0 : hexToNumber$1(chainId),
			nonce: nonce === "0x" ? 0 : hexToNumber$1(nonce),
...
function parseEIP155Signature(transactionArray) {
	...
	if (yParity !== 0n && yParity !== 1n) throw new InvalidYParityError({ yParity });
...
function fromTupleList$1(accessList) {
	...
	for (let i = 0; i < accessList.length; i++) {
		...
		list.push({
			address,
			storageKeys: storageKeys.map((key) => validate$2(key) ? key : trimLeft(key))
		});
	}
	return list;
}
...
*/
function fromRpc$6(transaction, _options = {}) {
...
//#endregion
//#region node_modules/ox/_esm/core/ContractAddress.js
/**
...
function fromCreate2(options) {
	const from = fromHex$1(from$10(options.from));
	const salt = padLeft(validate(options.salt) ? options.salt : fromHex$1(options.salt), 32);
	const bytecodeHash = (() => {
		if ("bytecodeHash" in options) {
			if (validate(options.bytecodeHash)) return options.bytecodeHash;
			return fromHex$1(options.bytecodeHash);
		}
		return keccak256$1(options.bytecode, { as: "Bytes" });
	})();
	return from$10(slice(keccak256$1(concat(fromHex$1("0xff"), from, salt, bytecodeHash), { as: "Hex" }), 12));
}
//#endregion
...
function verify$3(options) {
	...
	return secp256r1.verify(signature, payload instanceof Uint8Array ? payload : fromHex$1(payload), toHex$2(publicKey).substring(2), {
		lowS: true,
		...hash ? { prehash: true } : {}
	});
}
fromString("ox.p256.fromSeed.v1");
//#endregion
...
function verify$2(options) {
	...
	if (rpId !== void 0) {
		...
		if (!isEqual(rpIdHash, expectedRpIdHash)) return false;
	}
	...
	const clientDataJSONHash = sha256$1(fromString(clientDataJSON), { as: "Bytes" });
	return verify$3({
		hash: true,
		payload: concat(authenticatorDataBytes, clientDataJSONHash),
		publicKey,
		signature
	});
}
	...
	transactionRequest: /*#__PURE__*/ defineTransactionRequest({
		...
		format(args) {
			if (args.gasPerPubdata || args.paymaster && args.paymasterInput || args.factoryDeps || args.customSignature) return {
				eip712Meta: {
					...args.gasPerPubdata ? { gasPerPubdata: toHex$1(args.gasPerPubdata) } : { gasPerPubdata: toHex$1(gasPerPubdataDefault) },
...
function serializeTransaction$3(transaction, signature) {
	...
	return serializeTransaction$4(transaction, signature);
}
var serializers$2 = { transaction: serializeTransaction$3 };
function serializeTransactionEIP712(transaction) {
	...
	const serializedTransaction = [
		...
		toHex$1(chainId),
		from ?? "0x",
		gasPerPubdata ? toHex$1(gasPerPubdata) : toHex$1(gasPerPubdataDefault),
		factoryDeps ?? [],
		customSignature ?? "0x",
...
function hashBytecode(bytecode) {
	...
	const hashStr = sha256$2(bytecodeBytes);
...
function transactionToMessage(transaction) {
	...
	return {
		...
		value: value ?? 0n,
		data: data ?? "0x",
		factoryDeps: factoryDeps?.map((dep) => toHex$1(hashBytecode(dep))) ?? [],
...
var formatters$1 = {
	...
	transactionReceipt: /*#__PURE__*/ defineTransactionReceipt({ format(args) {
		return {
			...
			...args.depositReceiptVersion ? { depositReceiptVersion: hexToNumber$1(args.depositReceiptVersion) } : {},
...
var serializers$1 = { transaction: serializeTransaction$2 };
...
var ancient8 = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		l2OutputOracle: { [sourceId$69]: { address: "0xB09DC08428C8b4EFB4ff9C0827386CDF34277996" } },
		portal: { [sourceId$69]: {
			address: "0x639F2AECE398Aa76b07e59eF6abe2cFe32bacb68",
			blockCreated: 19070571
		} },
		l1StandardBridge: { [sourceId$69]: {
			address: "0xd5e3eDf5b68135D559D572E26bF863FBC1950033",
			blockCreated: 19070571
		} }
	},
	sourceId: sourceId$69
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ancient8Sepolia.js
var sourceId$68 = 11155111;
var ancient8Sepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$68]: { address: "0x942fD5017c0F60575930D8574Eaca13BEcD6e1bB" } },
		portal: { [sourceId$68]: {
...
var base = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$64]: { address: "0x43edB88C4B80fDD2AdFF2412A7BebF9dF42cB40e" } },
		l2OutputOracle: { [sourceId$64]: { address: "0x56315b90c40730925ec5485cf004d835058518A0" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 5022
		},
		...
		l1StandardBridge: { [sourceId$64]: {
			address: "0x3154Cf16ccdb4C6d922629664174b904d80F2C35",
			blockCreated: 17482143
		} }
	},
	sourceId: sourceId$64
});
...
var baseGoerli = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$63]: { address: "0x2A35891ff30313CcFa6CE88dcf3858bb075A2298" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 1376988
		},
		portal: { [sourceId$63]: { address: "0xe93c8cD0D409341205A592f8c4Ac1A5fe5585cfA" } },
		l1StandardBridge: { [sourceId$63]: { address: "0xfA6D8Ee5BE770F84FC001D098C4bD604Fe01284a" } }
	},
	testnet: true,
...
var baseSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$62]: { address: "0xd6E6dBf4F7EA0ac412fD8b65ED297e64BB7a06E1" } },
		l2OutputOracle: { [sourceId$62]: { address: "0x84457ca9D0163FbC4bbfe4Dfbb20ba46e48DF254" } },
		portal: { [sourceId$62]: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/battlechain.js
var battlechain = /*#__PURE__*/ defineChain({
	...chainConfig$4,
	id: 626,
	...
	rpcUrls: { default: { http: ["https://mainnet.battlechain.com"] } },
	blockExplorers: { default: {
...
var serializers = { transaction: serializeTransaction$1 };
...
function assertTransactionCIP64(transaction) {
	...
	if (chainId <= 0) throw new InvalidChainIdError$1({ chainId });
	if (to && !isAddress(to)) throw new InvalidAddressError({ address: to });
	if (gasPrice) throw new BaseError$1("`gasPrice` is not a valid CIP-64 Transaction attribute.");
	...
	if (isPresent(feeCurrency) && !isAddress(feeCurrency)) throw new BaseError$1("`feeCurrency` MUST be a token address for CIP-64 transactions.");
	if (isEmpty(feeCurrency)) throw new BaseError$1("`feeCurrency` must be provided for CIP-64 transactions.");
}
//#endregion
...
var celoAlfajores = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$57]: {
...
var codex = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$55]: { address: "0x6A3855dc26e2beA8Ac73f82Cda79f3808B6C6F6C" } },
		portal: { [sourceId$55]: { address: "0x52759C07A759c81BAab28AE1BE5A19e6450959bD" } },
		l1StandardBridge: { [sourceId$55]: { address: "0xa6b1A05a592719B0C8a70c69eac114C48410aDE4" } },
...
var codexTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$54]: { address: "0x390e24E8324E56f13A8d48eB938b6f9De24CD205" } },
		portal: { [sourceId$54]: { address: "0x037F161D12c829A9ca4742eEd9371830CA54fcB2" } },
		l1StandardBridge: { [sourceId$54]: { address: "0xCf4df2bDB14C8FDB25FdacCEC10Ce5C4bAEDB3De" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" }
	},
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/defiOracleMetaMainnet.js
var defiOracleMetaMainnet = /*#__PURE__*/ defineChain({
	id: 138,
...
var form = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		addressManager: { [sourceId$51]: { address: "0x15c249E46A2F924C2dB3A1560CF86729bAD1f07B" } },
		l1CrossDomainMessenger: { [sourceId$51]: { address: "0xF333158DCCad1dF6C3F0a3aEe8BC31fA94d9eD5c" } },
		l2OutputOracle: { [sourceId$51]: { address: "0x4ccAAF69F41c5810cA875183648B577CaCf1F67E" } },
		portal: { [sourceId$51]: { address: "0x4E259Ee5F4136408908160dD32295A5031Fa426F" } },
		l1StandardBridge: { [sourceId$51]: { address: "0xdc20aA63D3DE59574E065957190D8f24e0F7B8Ba" } },
		multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" }
	},
...
var formTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		addressManager: { [sourceId$50]: { address: "0xd5C38fa934f7fd7477D4800F4f38a1c5BFdF1373" } },
		l1CrossDomainMessenger: { [sourceId$50]: { address: "0x37A68565c4BE9700b3E3Ec60cC4416cAC3052FAa" } },
		l2OutputOracle: { [sourceId$50]: { address: "0x9eA2239E65a59EC9C7F1ED4C116dD58Da71Fc1e2" } },
		portal: { [sourceId$50]: { address: "0x60377e3cE15dF4CCA24c4beF076b60314240b032" } },
		l1StandardBridge: { [sourceId$50]: { address: "0xD4531f633942b2725896F47cD2aFd260b44Ab1F7" } },
		multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" }
	},
	testnet: true,
...
var fraxtal = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$49]: { address: "0x66CC916Ed5C6C2FA97014f7D1cD141528Ae171e4" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$49]: {
			address: "0x36cb65c1967A0Fb0EEE11569C51C2f2aA1Ca6f6D",
			blockCreated: 19135323
		} },
		l1StandardBridge: { [sourceId$49]: {
...
var fraxtalTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$48]: { address: "0x715EA64DA13F4d0831ece4Ad3E8c1aa013167F32" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$48]: {
...
var giwaSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$44]: { address: "0x37347caB2afaa49B776372279143D71ad1f354F6" } },
		portal: { [sourceId$44]: { address: "0x956962C34687A954e611A83619ABaA37Ce6bC78A" } },
		l1StandardBridge: { [sourceId$44]: { address: "0x77b2ffc0F57598cAe1DB76cb398059cF5d10A7E7" } }
	},
	testnet: true,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hausTestnet.js
var hausTestnet = /*#__PURE__*/ defineChain({
	id: 2443,
	...
	rpcUrls: { default: { http: ["https://rpc-testnet.hausserver.xyz"] } },
	blockExplorers: { default: {
...
var ink = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$41]: { address: "0x10d7b35078d3baabb96dd45a9143b94be65b12cd" } },
		portal: { [sourceId$41]: { address: "0x5d66c1782664115999c47c9fa5cd031f495d3e4f" } },
		l1StandardBridge: { [sourceId$41]: { address: "0x88ff1e5b602916615391f55854588efcbb7663f0" } }
	},
	testnet: false,
...
var inkSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$40]: { address: "0x860e626c700af381133d9f4af31412a2d1db3d5d" } },
		portal: { [sourceId$40]: { address: "0x5c1d29c6c9c8b0800692acc95d700bcb4966a1d7" } },
		l1StandardBridge: { [sourceId$40]: { address: "0x33f60714bbd74d62b66d79213c348614de51901c" } }
	},
	testnet: true,
...
async function estimateGas(client, args) {
	...
	try {
		const { accessList, blockNumber, blockTag, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, stateOverride, to, value, ...rest } = args;
		...
		const { baseFeePerGas, gasLimit, priorityFeePerGas } = await client.request({
			...
			params: rpcStateOverride ? block ? [
				request,
				block,
				rpcStateOverride
			] : [request, rpcStateOverride] : block ? [request, block] : [request]
		});
		return {
...
var lisk = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$39]: { address: "0x0CF7D3706a27CCE2017aEB11E8a9c8b5388c282C" } },
		multicall3: { address: "0xA9d71E1dd7ca26F26e656E66d6AA81ed7f745bf0" },
		l2OutputOracle: { [sourceId$39]: { address: "0x113cB99283AF242Da0A0C54347667edF531Aa7d6" } },
		portal: { [sourceId$39]: { address: "0x26dB93F8b8b4f7016240af62F7730979d353f9A7" } },
		l1StandardBridge: { [sourceId$39]: { address: "0x2658723Bf70c7667De6B25F99fcce13A16D25d08" } }
	},
	sourceId: sourceId$39
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/liskSepolia.js
var sourceId$38 = 11155111;
var liskSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$38]: { address: "0xA0E35F56C318DE1bD5D9ca6A94Fe7e37C5663348" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$38]: { address: "0xe3d90F21490686Ec7eF37BE788E02dfC12787264" } },
		l1StandardBridge: { [sourceId$38]: { address: "0x1Fb30e446eA791cd1f011675E5F3f5311b70faF5" } }
	},
	testnet: true,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/marooTestnet.js
var marooTestnet = /*#__PURE__*/ defineChain({
	id: 450815,
	name: "Maroo Testnet",
	nativeCurrency: {
		name: "Testnet OKRW",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/marsCredit.js
var marsCredit = /*#__PURE__*/ defineChain({
	id: 110110,
	name: "Mars Credit",
	nativeCurrency: {
		decimals: 18,
...
var megaeth = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$37]: { address: "0x8546840adF796875cD9AAcc5B3B048f6B2c9D563" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
			blockCreated: 0
		},
...
var metalL2 = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$36]: { address: "0x3B1F7aDa0Fcc26B13515af752Dd07fB1CAc11426" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
			blockCreated: 0
		},
		portal: { [sourceId$36]: { address: "0x3F37aBdE2C6b5B2ed6F8045787Df1ED1E3753956" } },
		l1StandardBridge: { [sourceId$36]: { address: "0x6d0f65D59b55B0FEC5d2d15365154DcADC140BF3" } }
	},
...
var mode = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$35]: { address: "0x6f13EFadABD9269D6cEAd22b448d434A1f1B433E" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 2465882
		},
		l2OutputOracle: { [sourceId$35]: { address: "0x4317ba146D4933D889518a3e5E11Fe7a53199b04" } },
		portal: { [sourceId$35]: { address: "0x8B34b14c7c7123459Cf3076b8Cb929BE097d0C07" } },
		l1StandardBridge: { [sourceId$35]: { address: "0x735aDBbE72226BD52e818E7181953f42E3b0FF21" } }
	},
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/morphTachyon.js
var morphTachyon = /*#__PURE__*/ defineChain({
	id: 2184,
	name: "Morph Tachyon",
	nativeCurrency: {
		name: "BGB",
	...
	rpcUrls: { default: { http: ["https://api.popdex.xyz/api/v1/web3/rpc"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/morphTachyonTestnet.js
var morphTachyonTestnet = /*#__PURE__*/ defineChain({
	id: 34952,
	...
	rpcUrls: { default: { http: ["https://testnet-api.popdex.xyz/api/v1/web3/rpc"] } },
	blockExplorers: { default: {
...
var opBNB = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		l2OutputOracle: { [sourceId$33]: { address: "0x153CAB79f4767E2ff862C94aa49573294B13D169" } },
		portal: { [sourceId$33]: { address: "0x1876EA7702C0ad0C6A2ae6036DE7733edfBca519" } },
		l1StandardBridge: { [sourceId$33]: { address: "0xF05F0e4362859c3331Cb9395CBC201E3Fa6757Ea" } }
	},
...
var opBNBTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		l2OutputOracle: { [sourceId$32]: { address: "0xFf2394Bb843012562f4349C6632a0EcB92fC8810" } },
		portal: { [sourceId$32]: { address: "0x4386C8ABf2009aC0c263462Da568DD9d46e52a31" } },
		l1StandardBridge: { [sourceId$32]: { address: "0x677311Fd2cCc511Bbc0f581E8d9a07B033D5E840" } }
	},
	testnet: true,
...
var optimism = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$31]: { address: "0xe5965Ab5962eDc7477C8520243A95517CD252fA9" } },
		l2OutputOracle: { [sourceId$31]: { address: "0xdfe97868233d1aa22e815a266982f2cf17685a27" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 4286263
		},
		portal: { [sourceId$31]: { address: "0xbEb5Fc579115071764c7423A4f12eDde41f106Ed" } },
		l1StandardBridge: { [sourceId$31]: { address: "0x99C9fc46f92E8a1c0deC1b1747d010903E884bE1" } }
	},
...
var optimismGoerli = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$30]: { address: "0xE6Dfba0953616Bacab0c9A8ecb3a9BBa77FC15c0" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 49461
		},
		portal: { [sourceId$30]: { address: "0x5b47E1A08Ea6d985D6649300584e6722Ec4B1383" } },
		l1StandardBridge: { [sourceId$30]: { address: "0x636Af16bf2f682dD3109e60102b8E1A089FedAa8" } }
	},
	testnet: true,
...
var optimismSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$29]: { address: "0x05F9613aDB30026FFd634f38e5C4dFd30a197Fa1" } },
		l2OutputOracle: { [sourceId$29]: { address: "0x90E9c4f8a994a250F6aEfd61CAFb4F2e895D458F" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 1620204
		},
		portal: { [sourceId$29]: { address: "0x16Fc5058F25648194471939df75CF27A2fdC48BC" } },
		l1StandardBridge: { [sourceId$29]: { address: "0xFBb0621E0B23b5478B630BD55a5f21f67730B0F1" } }
	},
	testnet: true,
...
var pgn = /*#__PURE__*/ defineChain({
	...
	contracts: {
		l2OutputOracle: { [sourceId$28]: { address: "0x9E6204F750cD866b299594e2aC9eA824E2e5f95c" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
			blockCreated: 3380209
		},
		portal: { [sourceId$28]: { address: "0xb26Fd985c5959bBB382BAFdD0b879E149e48116c" } },
		l1StandardBridge: { [sourceId$28]: { address: "0xD0204B9527C1bA7bD765Fa5CCD9355d38338272b" } }
	},
	formatters: formatters$1,
...
var pgnTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		l2OutputOracle: { [sourceId$27]: { address: "0xD5bAc3152ffC25318F848B3DD5dA6C85171BaEEe" } },
		portal: { [sourceId$27]: { address: "0xF04BdD5353Bb0EFF6CA60CfcC78594278eBfE179" } },
		l1StandardBridge: { [sourceId$27]: { address: "0xFaE6abCAF30D23e233AC7faF747F2fC3a5a6Bfa3" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
...
var polygonAmoy = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://polygon-amoy.drpc.org"] } },
	blockExplorers: { default: {
		name: "PolygonScan",
...
var sourceId$21 = 11155111;
var pyrope = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	name: "Pyrope Testnet",
	testnet: true,
	id: 695569,
	sourceId: sourceId$21,
	nativeCurrency: {
		name: "Ether",
		symbol: "ETH",
		decimals: 18
	...
	contracts: {
		...chainConfig$3.contracts,
		l1StandardBridge: { [sourceId$21]: { address: "0xC24932c31D9621aE9e792576152B7ef010cFC2F8" } }
	}
});
//#endregion
...
var redstone = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		l2OutputOracle: { [sourceId$20]: {
			address: "0xa426A052f657AEEefc298b3B5c35a470e4739d69",
			blockCreated: 19578337
		} },
		l1StandardBridge: { [sourceId$20]: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/robinhood.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/robinhoodTestnet.js
var robinhoodTestnet = /*#__PURE__*/ defineChain({
	id: 46630,
...
var rss3 = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$19]: { address: "0xE6f24d2C32B3109B18ed33cF08eFb490b1e09C10" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 14193
		},
		...
		l1StandardBridge: { [sourceId$19]: { address: "0x4cbab69108Aa72151EDa5A3c164eA86845f18438" } }
	},
	sourceId: sourceId$19
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rss3Sepolia.js
var sourceId$18 = 11155111;
var rss3Sepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$18]: { address: "0xDb5c46C3Eaa6Ed6aE8b2379785DF7dd029C0dC81" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 55697
		},
		...
		l1StandardBridge: { [sourceId$18]: { address: "0xdDD29bb63B0839FB1cE0eE439Ff027738595D07B" } }
	},
	testnet: true,
...
var snax = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$15]: { address: "0x472562Fcf26D6b2793f8E0b0fB660ba0E5e08A46" } },
		l2OutputOracle: { [sourceId$15]: { address: "0x2172e492Fc807F5d5645D0E3543f139ECF539294" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$15]: { address: "0x79f446D024d74D0Bb6E699C131c703463c5D65E9" } },
		l1StandardBridge: { [sourceId$15]: { address: "0x6534Bdb6b5c060d3e6aa833433333135eFE8E0aA" } }
	},
	sourceId: sourceId$15
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/snaxTestnet.js
var sourceId$14 = 11155111;
var snaxTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$14]: { address: "0x206a75d89d45F146C54020F132FF93bEDD09f55E" } },
		l2OutputOracle: { [sourceId$14]: { address: "0x60e3A368a4cdCEf85ffB964e372726F56A46221e" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$14]: { address: "0xb5afdd0E8dDF081Ef90e8A3e0c7b5798e66E954E" } },
		l1StandardBridge: { [sourceId$14]: { address: "0xbd37E1a59D4C00C9A46F75018dffd84061bC5f74" } }
	},
	testnet: true,
...
var soneium = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$13]: { address: "0x512a3d2c7a43bd9261d2b8e8c9c70d4bd4d503c0" } },
		l2OutputOracle: { [sourceId$13]: { address: "0x0000000000000000000000000000000000000000" } },
		portal: { [sourceId$13]: {
			address: "0x88e529a6ccd302c948689cd5156c83d4614fae92",
			blockCreated: 7061266
		} },
		l1StandardBridge: { [sourceId$13]: {
...
var soneiumMinato = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$12]: { address: "0xB3Ad2c38E6e0640d7ce6aA952AB3A60E81bf7a01" } },
		l2OutputOracle: { [sourceId$12]: { address: "0x710e5286C746eC38beeB7538d0146f60D27be343" } },
		portal: { [sourceId$12]: {
...
var story = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://mainnet.datarpc.io"] } },
	blockExplorers: { default: {
...
var storyAeneid = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://aeneid.datarpc.io"] } },
	blockExplorers: { default: {
...
var recoveryFactory = "0x8a196A227C48Ae8A3E36EebD4E106675CC0f6E64";
/** Keccak-256 of the canonical recovery wallet creation code. */
var recoveryWalletInitCodeHash = "0x4b5ff53c5328a10a6ec5224adf16de5e204a47057c98af037ee30b7de660a8a6";
...
function assert$2(config) {
	...
	if (owners.length > 48) throw new InvalidConfigError({ reason: "too many owners" });
	if (!Number.isInteger(Number(threshold))) throw new InvalidConfigError({ reason: "threshold must be an integer" });
	if (Number(threshold) < 1) throw new InvalidConfigError({ reason: "threshold cannot be zero" });
	if (Number(threshold) > 255) throw new InvalidConfigError({ reason: "threshold exceeds max threshold" });
	let totalWeight = 0;
	const weights = [];
	let previous;
	for (const owner of owners) {
		if (!validate$3(owner.owner) || toBigInt(owner.owner) === 0n) throw new InvalidConfigError({ reason: "owner cannot be zero" });
		if (!Number.isInteger(Number(owner.weight))) throw new InvalidConfigError({ reason: "owner weight must be an integer" });
	...
	if (totalWeight > 255) throw new InvalidConfigError({ reason: "total owner weight exceeds u8 max" });
	if (Number(threshold) > totalWeight) throw new InvalidConfigError({ reason: "threshold exceeds total owner weight" });
	const reachableWeight = weights.sort((a, b) => b - a).slice(0, 8).reduce((sum, weight) => sum + weight, 0);
	if (Number(threshold) > reachableWeight) throw new InvalidConfigError({ reason: `threshold exceeds weight reachable by 8 owner signatures` });
}
function from$5(config) {
	const version = config.version ?? 0n;
	assertVersion(version);
	const normalized = {
		owners: [...config.owners].sort((a, b) => toBigInt(a.owner) < toBigInt(b.owner) ? -1 : 1),
...
*/
function fromRpc$5(config) {
	return from$5({
		...config,
		version: toBigInt(config.version)
	});
}
/**
...
function fromTuple$2(tuple) {
	...
	return {
		...
		version: version === "0x" ? 0n : toBigInt(version)
	};
}
/**
...
function getAddress(config) {
	assert$2(config);
	if (BigInt(config.version ?? 0) !== 0n) throw new InvalidConfigError({ reason: "account address requires version zero" });
	const account = fromCreate2({
		bytecodeHash: recoveryWalletInitCodeHash,
		from: recoveryFactory,
		salt: keccak256$1(concat$1(fromString$1(accountDomain), padLeft$1(config.salt ?? zeroSalt, 32), fromNumber(config.threshold, { size: 1 }), fromNumber(config.owners.length, { size: 1 }), ...config.owners.flatMap((owner) => [owner.owner, fromNumber(owner.weight, { size: 1 })])))
	});
	if (toBigInt(account) === 0n) throw new InvalidConfigError({ reason: "derived account cannot be zero" });
	if (config.owners.some((owner) => isEqual$2(owner.owner, account))) throw new InvalidConfigError({ reason: "derived account cannot be an owner" });
	return account;
}
/**
...
function getSignPayload$2(value) {
	...
	return keccak256$1(concat$1(fromString$1(signatureDomain), from$7(payload), account, fromNumber(config.version ?? 0n, { size: 8 })));
}
/**
...
function toTuple$2(config) {
	...
	return [
		salt,
		version === 0n ? "0x" : fromNumber(version),
...
function assertVersion(version) {
	if (typeof version !== "bigint" && typeof version !== "number" || typeof version === "number" && !Number.isSafeInteger(version) || BigInt(version) < 0n || BigInt(version) > maxVersion) throw new InvalidConfigError({ reason: "version must be an unsigned 64-bit integer" });
}
//#endregion
...
function assert$1(envelope) {
	...
	if (type === "keychain") {
		assert$1(envelope.inner);
		return;
	}
	if (type === "multisig") {
		assertMultisig(envelope, 1);
		return;
	}
}
function assertMultisig(envelope, depth) {
	...
	if (depth > 2) throw new InvalidMultisigApprovalError({ reason: `multisig nesting depth exceeds 2` });
	if (!validate$3(envelope.account)) throw new InvalidMultisigApprovalError({ reason: "multisig account is invalid" });
	if (toBigInt(envelope.account) === 0n) throw new InvalidMultisigApprovalError({ reason: "multisig account cannot be zero" });
	assert$2(envelope.config);
	if (envelope.config.owners.some((owner) => isEqual$2(owner.owner, envelope.account))) throw new InvalidMultisigApprovalError({ reason: "multisig account cannot be an owner" });
	if (envelope.config.version === 0n && !isEqual$2(getAddress(envelope.config), envelope.account)) throw new InvalidMultisigApprovalError({ reason: "initial multisig config does not derive account" });
	if (envelope.signatures.length === 0) throw new InvalidMultisigApprovalError({ reason: "multisig signatures cannot be empty" });
	if (envelope.signatures.length > 8) throw new InvalidMultisigApprovalError({ reason: `multisig signatures exceed 8` });
	for (const inner of envelope.signatures) {
		const type = getType$1(inner);
		if (type === "keychain") throw new InvalidMultisigApprovalError({ reason: "keychain owner approvals are not allowed" });
		if (type === "multisig") assertMultisig(inner, depth + 1);
		else {
			assert$1(inner);
			if (size(serialize$3(inner)) > 2049) throw new InvalidMultisigApprovalError({ reason: `multisig owner signature exceeds ${maxOwnerSignatureBytes} bytes` });
		}
	}
}
/**
...
function deserialize_(value, multisigDepth) {
	...
	if (typeId === serializedKeychainType || typeId === serializedKeychainV2Type) return {
		...
		inner: deserialize_(slice(data, 20), multisigDepth),
		type: "keychain",
		version: typeId === serializedKeychainV2Type ? "v2" : "v1"
	};
	if (typeId === serializedMultisigType) {
		const depth = multisigDepth + 1;
		if (depth > 2) throw new InvalidSerializedError({
			reason: `multisig nesting depth exceeds 2`,
			serialized
		});
		const decoded = toHex(data);
		if (!Array.isArray(decoded) || decoded.length !== 3) throw new InvalidSerializedError({
			reason: "invalid multisig wire shape: expected exactly three fields",
			serialized
		});
		const [account, config, signatures] = decoded;
		if (!validate$3(account)) throw new InvalidSerializedError({
			reason: "invalid multisig account",
			serialized
		});
		if (!Array.isArray(config)) throw new InvalidSerializedError({
			reason: "invalid multisig config",
			serialized
		});
		const [salt, version, threshold, owners] = config;
		if (config.length !== 4 || Array.isArray(salt) || size(salt) !== 32 || Array.isArray(version) || size(version) > 8 || version !== "0x" && slice(version, 0, 1) === "0x00" || Array.isArray(threshold) || size(threshold) > 1 || !Array.isArray(owners) || owners.some((owner) => !Array.isArray(owner) || owner.length !== 2 || owner.some(Array.isArray) || !validate$3(owner[0]) || size(owner[1]) > 1)) throw new InvalidSerializedError({
			reason: "invalid multisig config",
			serialized
		});
		if (!Array.isArray(signatures) || signatures.some(Array.isArray)) throw new InvalidSerializedError({
			reason: "invalid multisig signatures list",
			serialized
		});
		if (signatures.length === 0) throw new InvalidSerializedError({
			reason: "multisig signatures cannot be empty",
			serialized
		});
		if (signatures.length > 8) throw new InvalidSerializedError({
			reason: `multisig signatures exceed 8`,
			serialized
		});
		for (const signature of signatures) if (size(signature) > 2049 && slice(signature, 0, 1) !== "0x05") throw new InvalidSerializedError({
			reason: `multisig owner signature exceeds ${maxOwnerSignatureBytes} bytes`,
			serialized
		});
		const envelope = {
			account,
			config: fromTuple$2(config),
...
*/
function from$4(value, options) {
	if (typeof value === "string") return deserialize$3(value);
	...
	if (type === "multisig") {
		...
		const config = from$5(multisig.config);
		const envelope = {
			account: multisig.account ?? getAddress(config),
			config,
			signatures: multisig.signatures.map((signature) => from$4(signature)),
			type
		};
		assert$1(envelope);
		return envelope;
...
function fromRpc$4(envelope) {
	if (typeof envelope === "string") {
		const serialized = concat$1(serializedMultisigType, envelope);
		const result = deserialize$3(serialized);
		if (result.type !== "multisig" || !isEqual$1(serialize$3(result), serialized)) throw new InvalidSerializedError({
...
function getType$1(envelope) {
	...
	if ("config" in envelope && "signatures" in envelope) return "multisig";
	throw new CoercionError({ envelope });
}
/**
...
function serialize$3(envelope, options = {}) {
	...
	if (type === "webAuthn") {
		const webauthn = envelope;
		const webauthnData = concat$1(webauthn.metadata.authenticatorData, fromString$1(webauthn.metadata.clientDataJSON));
		return concat$1(serializedWebAuthnType, webauthnData, fromNumber(webauthn.signature.r, { size: 32 }), fromNumber(webauthn.signature.s, { size: 32 }), fromNumber(webauthn.publicKey.x, { size: 32 }), fromNumber(webauthn.publicKey.y, { size: 32 }), options.magic ? magicBytes : "0x");
	}
	if (type === "keychain") {
		const keychain = envelope;
		const keychainTypeId = keychain.version === "v1" ? serializedKeychainType : serializedKeychainV2Type;
		return concat$1(keychainTypeId, keychain.userAddress, serialize$3(keychain.inner), options.magic ? magicBytes : "0x");
	}
	if (type === "multisig") {
		const multisig = envelope;
		assert$1(multisig);
		return concat$1(serializedMultisigType, fromHex([
			multisig.account,
			toTuple$2(multisig.config),
			multisig.signatures.map((signature) => serialize$3(signature))
...
function sortMultisigApprovals(value) {
	...
	const digest = getSignPayload$2({
		account,
		config: from$5(config),
		payload
	});
...
function toRpc$4(envelope) {
	...
	if (type === "multisig") return slice(serialize$3(envelope), 1);
	throw new CoercionError({ envelope });
}
/**
...
function verify(signature, parameters) {
	...
	const envelope = from$4(signature);
	...
	if (envelope.type === "p256") {
		...
		if (!isEqual$2(envelopeAddress, address)) return false;
		return verify$3({
...
*/
var InvalidMultisigApprovalError = class extends BaseError {
	constructor({ reason }) {
...
function fromTuple$1(tuple) {
	...
	if (signatureSerialized) args.signature = deserialize$3(signatureSerialized);
	return from$3(args);
}
/**
...
function toTuple$1(authorization) {
	const { address, chainId, nonce } = authorization;
	const signature = authorization.signature ? serialize$3(authorization.signature) : void 0;
	return [
...
function from$2(authorization, options = {}) {
	...
	if (options.signature) {
		const signature = from$4(options.signature);
...
function fromRpc$2(authorization) {
	...
	const accountBinding = account !== void 0 ? {
		account,
...
function fromTuple(tuple) {
	...
	if (signatureSerialized) {
		const signature = deserialize$3(signatureSerialized);
		assertSignature(signature);
...
* @returns The {@link ox#KeyAuthorization.KeyAuthorization}.
*/
function deserialize$2(serialized) {
	return fromTuple(toHex(serialized));
}
/**
...
*/
function serialize$2(authorization) {
	return fromHex(toTuple(authorization));
}
/**
...
function toTuple(authorization) {
	...
	if (witness !== void 0) assertWitness(witness);
	const signature = (() => {
		if (!authorization.signature) return void 0;
		assertSignature(authorization.signature);
		return serialize$3(authorization.signature);
	})();
	const type = (() => {
...
function assertSignature(signature) {
	if (signature.type === "keychain") throw new InvalidSignatureTypeError(signature.type);
}
...
*/
function deserialize$1(serialized) {
	...
	if (feePayerSignatureOrSender !== "0x" && feePayerSignatureOrSender !== void 0) {
		if (feePayerSignatureOrSender === "0x00" || validate$3(feePayerSignatureOrSender)) {
			transaction.feePayerSignature = null;
			if (validate$3(feePayerSignatureOrSender)) transaction.from = feePayerSignatureOrSender;
	...
	const signatureEnvelope = signature ? deserialize$3(signature) : void 0;
	...
	if (!transaction.from && signatureEnvelope) try {
		transaction.from = extractAddress({
			payload: getSignPayload(from$1(transaction)),
			signature: signatureEnvelope,
			root: true
		});
	} catch {}
...
*/
function from$1(envelope, options = {}) {
	const { feePayerSignature, signature } = options;
	const envelope_ = typeof envelope === "string" ? deserialize$1(envelope) : envelope;
	...
	return {
		...envelope_,
		...signature ? { signature: from$4(signature) } : {},
		...feePayerSignature ? { feePayerSignature: from$11(feePayerSignature) } : {},
		type: "tempo"
	};
}
/**
...
function serialize$1(envelope, options = {}) {
	...
	const feePayerSignatureOrSender = (() => {
		...
		if (options.format === "feePayer" && signature) {
			...
			if (sig.type === "secp256k1") return recoverAddress({
				payload: getSignPayload(from$1(envelope)),
	...
	const serialized = [
		...
		...signature ? [serialize$3(from$4(signature))] : []
	];
	return concat$1(options.format === "feePayer" ? feePayerMagic : serializedType, fromHex(serialized));
}
/**
...
function hash(envelope, options = {}) {
	const serialized = options.presign ? encodeForSigning(envelope) : serialize$1(envelope);
	return keccak256$1(serialized);
}
/**
...
//#endregion
//#region node_modules/ox/_esm/tempo/MultisigOperation.js
/**
...
function getHash(options) {
	...
	return getSignPayload$2({
		account,
		config,
		payload: options.type === "transaction" ? getSignPayload(deserialize$1(options.transaction)) : getSignPayload$1(deserialize$2(options.keyAuthorization))
	});
}
/**
...
async function selectApprovals(options) {
	...
	if (!validate$3(account) || toBigInt(account) === 0n) throw new InvalidApprovalError({ reason: "account is invalid" });
	if (!validate$2(hash)) throw new InvalidApprovalError({ reason: "hash is invalid" });
	const config = from$5(options.config);
	if (config.version === 0n && !isEqual$2(getAddress(config), account)) throw new InvalidApprovalError({ reason: "initial config does not derive the root multisig account" });
...
function serializeKeyAuthorization(keyAuthorization, options) {
	const authorization = deserialize$2(keyAuthorization);
	if (authorization.signature) throw new InvalidOperationError({ reason: "keyAuthorization must not contain a signature" });
	if (serialize$2(authorization).toLowerCase() !== keyAuthorization.toLowerCase()) throw new InvalidOperationError({ reason: "keyAuthorization is not canonically serialized" });
	const config = from$5(options.config);
	const signatures = sortMultisigApprovals({
		account: options.account,
		config,
		payload: getSignPayload$1(authorization),
		signatures: options.approvals.map((approval) => deserialize$3(approval))
	});
	return serialize$2(from$2(authorization, { signature: from$4({
		account: options.account,
		config,
		signatures
	}) }));
...
function from(operation) {
	try {
		const config = from$5(operation.config);
		if (typeof config.threshold !== "number" || config.owners.some((owner) => typeof owner.weight !== "number")) throw new InvalidOperationError({ reason: "config threshold and owner weights must be numbers" });
		const value = {
			...operation,
			config
		};
		...
		else if (value.type === "keyAuthorization") assertKeyAuthorization(value, config);
...
* @returns The validated operation.
*/
function fromRpc$1(operation) {
	try {
		const version = operation.config?.version;
		if (typeof version !== "string" || !validate$1(version)) throw new InvalidOperationError({ reason: "config.version must be a hexadecimal quantity" });
		const version_ = toBigInt(version);
		if (fromNumber(version_) !== version) throw new InvalidOperationError({ reason: "config.version must use canonical quantity encoding" });
		return from({
			...operation,
			config: fromRpc$5(operation.config)
		});
	} catch (cause) {
		if (cause instanceof InvalidOperationError) throw cause;
		throw new InvalidOperationError({ cause });
...
async function selectApprovals_internal(options, path) {
	const owners = new Map(options.config.owners.map((owner) => [owner.owner.toLowerCase(), {
		address: owner.owner,
		weight: Number(owner.weight)
	}]));
	const groups = /* @__PURE__ */ new Map();
	for (const serialized of options.approvals) {
		const signature = from$4(serialized);
		if (signature.type === "keychain") throw new InvalidApprovalError({ reason: "keychain signatures cannot approve a multisig operation" });
		const address = signature.type === "multisig" ? signature.account : extractAddress({
			payload: options.hash,
			signature
		});
		const owner = owners.get(address.toLowerCase());
		if (!owner) throw new InvalidApprovalError({ reason: `signature is from non-owner ${address}` });
	...
	for (const group of groups.values()) {
		...
		if (nested.length > 0) {
			if (nested.length !== group.signatures.length) throw new InvalidApprovalError({ reason: `owner ${group.address} has conflicting signature types` });
			if (path.length >= 2 || path.includes(group.address.toLowerCase())) throw new InvalidApprovalError({ reason: `nested multisig owner ${group.address} is invalid` });
			const config = from$5(nested[0].config);
			if (nested.some((signature) => !sameConfig(signature.config, config))) throw new InvalidApprovalError({ reason: `nested multisig owner ${group.address} has conflicting config witnesses` });
			if (config.version === 0n && !isEqual$2(getAddress(config), group.address)) throw new InvalidApprovalError({ reason: `initial config does not derive nested multisig owner ${group.address}` });
			const selected = await selectApprovals_internal({
				account: group.address,
				approvals: nested.flatMap((signature) => signature.signatures.map((approval) => serialize$3(approval))),
				config,
				hash: getSignPayload$2({
					account: group.address,
					config,
					payload: options.hash
				})
			...
			retained.push({
				...
				signature: serialize$3(from$4({
					account: group.address,
					config,
					signatures: selected.approvals.map((approval) => from$4(approval))
				}))
			});
			if (selected.weight >= selected.threshold) valid.push({
				address: group.address,
				signature: serialize$3(from$4({
					account: group.address,
					config,
					signatures: selected.selectedApprovals.map((approval) => from$4(approval))
				})),
				weight: group.weight
			});
			continue;
		}
		const signature = group.signatures.map((signature) => {
			if (!verify(signature, {
				address: group.address,
				payload: options.hash
			})) throw new InvalidApprovalError({ reason: `signature from owner ${group.address} is invalid` });
			return serialize$3(signature);
		}).sort(compareHex)[0];
		valid.push({
			address: group.address,
			signature,
	...
	const selected = [];
	let weight = 0;
	for (const approval of ranked.slice(0, 8)) {
	...
	return {
		approvals: retained.sort(compareApprovalAddress).map((approval) => approval.signature),
...
function compareApprovalAddress(a, b) {
	const addressA = toBigInt(a.address);
	const addressB = toBigInt(b.address);
...
function assertBase(operation, config) {
	if (!validate$3(operation.account)) throw new InvalidOperationError({ reason: "account is invalid" });
	if (toBigInt(operation.account) === 0n) throw new InvalidOperationError({ reason: "account cannot be zero" });
	if (!validate$2(operation.hash)) throw new InvalidOperationError({ reason: "hash is invalid" });
	assertInteger(operation.createdAt, "createdAt");
	assertInteger(operation.updatedAt, "updatedAt");
	if (operation.updatedAt < operation.createdAt) throw new InvalidOperationError({ reason: "updatedAt cannot precede createdAt" });
	...
	if (operation.threshold !== Number(config.threshold)) throw new InvalidOperationError({ reason: "threshold must equal config.threshold" });
	if (operation.weight > 255) throw new InvalidOperationError({ reason: "weight exceeds u8 max" });
	if (operation.signatureCount > 8) throw new InvalidOperationError({ reason: "too many selected signatures" });
	if (!Array.isArray(operation.approvals)) throw new InvalidOperationError({ reason: "approvals must be an array" });
	if (operation.approvals.length > config.owners.length) throw new InvalidOperationError({ reason: "too many retained approvals" });
	if (operation.signatureCount > operation.approvals.length) throw new InvalidOperationError({ reason: "signatureCount exceeds retained approvals" });
	if (operation.signatureCount === 0 !== (operation.weight === 0)) throw new InvalidOperationError({ reason: "signatureCount and weight must both be zero or nonzero" });
	const owners = new Map(config.owners.map((owner) => [owner.owner.toLowerCase(), Number(owner.weight)]));
	const approvalWeights = [];
	const seen = /* @__PURE__ */ new Set();
	for (const approval of operation.approvals) {
		if (typeof approval !== "string" || !validate$1(approval, { strict: true })) throw new InvalidOperationError({ reason: "approval is invalid" });
		const signature = assertApproval(operation.account, approval, config);
		const key = extractAddress({
			payload: operation.hash,
			signature
		}).toLowerCase();
		const weight = owners.get(key);
		if (weight === void 0) throw new InvalidOperationError({ reason: "approval is from a non-owner" });
		if (seen.has(key)) throw new InvalidOperationError({ reason: operation.type === "keyAuthorization" ? "key authorization contains duplicate owner approvals" : "duplicate owner approval" });
		seen.add(key);
		approvalWeights.push(weight);
	}
	if (!isWeightReachable(approvalWeights, operation.signatureCount, operation.weight)) throw new InvalidOperationError({ reason: "weight is not reachable by signatureCount retained owner approvals" });
	if (config.version === 0n && !isEqual$2(getAddress(config), operation.account)) throw new InvalidOperationError({ reason: "initial config does not derive the operation account" });
}
/**
...
function assertTransaction(operation) {
	if ("keyAuthorization" in operation && operation.keyAuthorization !== void 0) throw new InvalidOperationError({ reason: "transaction operations cannot contain keyAuthorization" });
	...
	if (operation.status === "pending") {
		if (expiresAt !== void 0 || submissionId !== void 0 || transactionHash !== void 0) throw new InvalidOperationError({ reason: "pending transactions cannot contain submission fields" });
	} else if (operation.status === "submitting") {
		assertInteger(expiresAt, "expiresAt");
		if (!validate$2(submissionId ?? "")) throw new InvalidOperationError({ reason: "submissionId is invalid" });
		if (submissionId.toLowerCase() === operation.hash.toLowerCase()) throw new InvalidOperationError({ reason: "submissionId must differ from the operation hash" });
		if (transactionHash !== void 0) throw new InvalidOperationError({ reason: "submitting transactions cannot contain transactionHash" });
	} else if (operation.status === "success") {
		if (!validate$2(transactionHash ?? "")) throw new InvalidOperationError({ reason: "transactionHash is invalid" });
		if (expiresAt !== void 0 || submissionId !== void 0) throw new InvalidOperationError({ reason: "successful transactions cannot contain submission fields" });
	} else throw new InvalidOperationError({ reason: "invalid transaction status" });
	if (operation.status !== "pending" && (operation.weight < operation.threshold || operation.signatureCount === 0)) throw new InvalidOperationError({ reason: "submitted transactions must have quorum" });
	if (typeof operation.transaction !== "string") throw new InvalidOperationError({ reason: "transaction is invalid" });
	const transaction = deserialize$1(operation.transaction);
	if (transaction.signature) throw new InvalidOperationError({ reason: "transaction must not contain an outer sender signature" });
	if (transaction.from && transaction.from.toLowerCase() !== operation.account.toLowerCase()) throw new InvalidOperationError({ reason: "transaction sender does not match the operation account" });
	assertOperationHash(operation, getSignPayload(transaction));
	if (serialize$1(transaction, operation.transaction.startsWith(feePayerMagic) ? transaction.from ? {
		format: "feePayer",
		sender: transaction.from
	} : { format: "feePayer" } : {}).toLowerCase() !== operation.transaction.toLowerCase()) throw new InvalidOperationError({ reason: "transaction is not canonically serialized" });
}
/**
...
function assertKeyAuthorization(operation, config) {
	...
	if (transactionFields.expiresAt !== void 0 || transactionFields.submissionId !== void 0 || transactionFields.transaction !== void 0 || transactionFields.transactionHash !== void 0) throw new InvalidOperationError({ reason: "key authorization operations cannot contain transaction fields" });
	if (operation.status !== "pending" && operation.status !== "success") throw new InvalidOperationError({ reason: "invalid key authorization status" });
	if (operation.status === "success" && (operation.weight < operation.threshold || operation.signatureCount === 0)) throw new InvalidOperationError({ reason: "successful key authorizations must have quorum" });
	if (operation.status === "pending" && operation.weight >= operation.threshold) throw new InvalidOperationError({ reason: "pending key authorizations cannot have quorum" });
	if (typeof operation.keyAuthorization !== "string") throw new InvalidOperationError({ reason: "keyAuthorization is invalid" });
	const authorization = deserialize$2(operation.keyAuthorization);
	if (!authorization.account || authorization.account.toLowerCase() !== operation.account.toLowerCase()) throw new InvalidOperationError({ reason: "key authorization account does not match the operation account" });
	const signature = authorization.signature;
	if (operation.status === "pending" && signature) throw new InvalidOperationError({ reason: "pending key authorizations must be unsigned" });
	if (operation.status === "success") {
		if (signature?.type !== "multisig") throw new InvalidOperationError({ reason: "successful key authorizations require a multisig signature" });
		if (signature.account.toLowerCase() !== operation.account.toLowerCase()) throw new InvalidOperationError({ reason: "key authorization signature account does not match" });
		if (signature.signatures.length !== operation.signatureCount) throw new InvalidOperationError({ reason: "key authorization signatureCount does not match its signature" });
		assertSelectedApprovals(operation, signature.signatures, authorization);
		if (!sameConfig(signature.config, config)) throw new InvalidOperationError({ reason: "key authorization config does not match" });
	}
	assertOperationHash(operation, getSignPayload$1(authorization));
	if (serialize$2(authorization).toLowerCase() !== operation.keyAuthorization.toLowerCase()) throw new InvalidOperationError({ reason: "keyAuthorization is not canonically serialized" });
}
/**
...
function assertApproval(account, serialized, config) {
	const approval = deserialize$3(serialized);
	assert$1({
		account,
		config,
		signatures: [approval],
	...
	if (serialize$3(approval).toLowerCase() !== serialized.toLowerCase()) throw new InvalidOperationError({ reason: "approval is not canonical" });
	return approval;
}
/**
...
function assertSelectedApprovals(operation, selected, authorization) {
	const retained = operation.approvals.map((approval) => deserialize$3(approval));
	for (const approval of selected) {
		const index = retained.findIndex((candidate) => includesApproval(candidate, approval));
		if (index === -1) throw new InvalidOperationError({ reason: "key authorization signature is not a retained approval" });
	...
	const addresses = selected.map((signature) => extractAddress({
		payload: digest,
		signature
	}));
	for (let index = 1; index < addresses.length; index++) {
		const previous = toBigInt(addresses[index - 1]);
		const current = toBigInt(addresses[index]);
		if (previous === current) throw new InvalidOperationError({ reason: "key authorization contains duplicate owner approvals" });
		if (previous > current) throw new InvalidOperationError({ reason: "key authorization approvals are not canonically ordered" });
	}
}
/**
...
function includesApproval(retained, selected) {
	if (retained.type !== "multisig" || selected.type !== "multisig") return serialize$3(retained).toLowerCase() === serialize$3(selected).toLowerCase();
	if (retained.account.toLowerCase() !== selected.account.toLowerCase()) return false;
	if (!sameConfig(retained.config, selected.config)) return false;
	let index = 0;
	for (const approval of selected.signatures) {
		while (index < retained.signatures.length && !includesApproval(retained.signatures[index], approval)) index++;
...
function isWeightReachable(weights, signatureCount, weight) {
	const reachable = Array.from({ length: signatureCount + 1 }, () => /* @__PURE__ */ new Set());
	reachable[0].add(0);
	for (const ownerWeight of weights) for (let count = signatureCount; count > 0; count--) for (const current of reachable[count - 1]) reachable[count].add(current + ownerWeight);
...
function assertOperationHash(operation, payload) {
	if (getSignPayload$2({
		...
		config: operation.config,
		payload
	}).toLowerCase() !== operation.hash.toLowerCase()) throw new InvalidOperationError({ reason: "hash does not match the operation payload" });
}
/**
...
function assertInteger(value, field) {
	if (typeof value !== "number" || !Number.isSafeInteger(value) || value < 0) throw new InvalidOperationError({ reason: `${field} must be a nonnegative safe integer` });
}
/**
...
function sameConfig(a, b) {
	const configA = from$5(a);
	const configB = from$5(b);
	return isEqual$1(configA.salt ?? zeroSalt, configB.salt ?? zeroSalt) && configA.threshold === configB.threshold && configA.version === configB.version && configA.owners.length === configB.owners.length && configA.owners.every((owner, index) => {
		const other = configB.owners[index];
		return isEqual$2(owner.owner, other.owner) && owner.weight === other.weight;
	});
}
/** Thrown when a multisig owner approval is invalid. */
var InvalidApprovalError = class extends BaseError {
	/**
	...
	*/
	constructor(options = {}) {
		super(options.reason ? `Invalid multisig approval: ${options.reason}.` : "Invalid multisig approval.", { cause: options.cause });
		Object.defineProperty(this, "name", {
			enumerable: true,
			configurable: true,
			writable: true,
...
var InvalidOperationError = class extends BaseError {
	/**
	...
	*/
	constructor(options = {}) {
		super(options.reason ? `Invalid multisig operation: ${options.reason}.` : "Invalid multisig operation.", { cause: options.cause });
		Object.defineProperty(this, "name", {
			enumerable: true,
			configurable: true,
			writable: true,
...
//#endregion
//#region node_modules/ox/_esm/tempo/MultisigSimulation.js
/**
...
*/
function toRpc$1(spec) {
	const { account, approvals, config } = spec;
	assertApprovalCount(approvals);
	return {
		account,
		approvals: approvals.map((approval) => {
			if (approval.type === "primitive") return {
				...approval,
				...typeof approval.keyData !== "undefined" ? { keyData: shimKeyData$1(approval.keyData) } : {}
			};
...
function assertApprovalCount(approvals) {
	if (approvals.length > 8) throw new InvalidSimulationError({ reason: `approval count exceeds 8` });
}
/** @internal */
function serializeConfig(config) {
	return fromHex(toTuple$2(config));
}
/**
* Shims long key data into the length hint accepted by Tempo's gas estimator.
* @internal
*/
function shimKeyData$1(data) {
	const size$2 = size(data);
	if (size$2 <= 4) return data;
	return fromNumber(size$2, { size: 2 });
}
/** Thrown when a native multisig simulation spec is invalid. */
var InvalidSimulationError = class extends BaseError {
	constructor(options) {
...
function fromRpc(transaction, _options = {}) {
	if (!transaction) return null;
	const transaction_ = fromRpc$6(transaction);
	...
	if (transaction.feePayerSignature) {
		transaction_.feePayerSignature = fromRpc$7(transaction.feePayerSignature);
...
function toRpc(request) {
	...
	if (request.multisigSimulation) request_rpc.multisigSimulation = toRpc$1(request.multisigSimulation);
...
//#endregion
//#region node_modules/ox/_esm/tempo/ZoneId.js
var chainIdConfig = {
	4217: {
		base: 4217e5,
		range: 100261e4
...
chainIdConfig[defaultSourceId].base;
/**
...
var UnsupportedSourceIdError = class extends BaseError {
	constructor({ sourceId }) {
		super(`Source chain ID "${sourceId}" is not supported.`, { metaMessages: ["Supported source chain IDs: 4217, 42431."] });
		Object.defineProperty(this, "name", {
			enumerable: true,
			configurable: true,
			writable: true,
...
function getChainIdConfig(sourceId) {
	if (sourceId === 4217 || sourceId === 42431) return chainIdConfig[sourceId];
...
var nativeMultisig$1 = [
	...
	{
		name: "InvalidOwnerOrder",
		type: "error",
		inputs: []
	},
	{
		name: "UnauthorizedMultisigCaller",
		type: "error",
		inputs: []
	}
];
...
var zoneFactory = [
	...
	{
		name: "DuplicateAllowedAccount",
		type: "error",
		inputs: []
	},
	{
		name: "DuplicateZoneGateway",
		type: "error",
		inputs: []
	},
	{
...
var earnContributionController = [
	{
		type: "constructor",
		inputs: [{
			name: "earnVault_",
...
var earnFactory = [
	{
		...
		inputs: [
			...
			{
				name: "earnVaultImplementation_",
				type: "address"
			},
			{
				name: "earnFeesImplementation_",
				type: "address"
			}
		],
		stateMutability: "nonpayable"
					...
					components: [
						...
						},
						{
							...
							components: [
								...
								{
									name: "annualTargetRateBps",
									type: "uint16"
								},
								{
									name: "excessFeeRateBps",
									type: "uint16"
								}
							]
						}
	...
	{
		type: "error",
		name: "AdminRelinquishmentFailed",
		inputs: []
	},
	{
		type: "error",
	...
	{
		type: "error",
		name: "FactoryCannotBeFinalOwner",
		inputs: []
	},
	{
		type: "error",
	...
	{
		type: "error",
		name: "InvalidEarnFeesImplementation",
		inputs: []
	},
	{
		type: "error",
		name: "InvalidEarnVaultImplementation",
		inputs: []
	},
	{
		type: "error",
...
var earnFees = [
	...
	},
	{
		...
		outputs: [{
			...
			components: [
				...
				{
					name: "totalFeeEarnShares",
					type: "uint256"
				},
				{
					name: "preFeeValuePerEarnShare",
					type: "uint256"
				},
				{
					name: "postFeeValuePerEarnShare",
					type: "uint256"
				},
				{
					name: "targetValuePerEarnShare",
					type: "uint256"
				},
				{
	...
	{
		type: "error",
		name: "InsufficientClaimableEarnShares",
		inputs: []
	},
	{
		type: "error",
		name: "InvalidFeeClaimReceiver",
		inputs: []
	},
	{
		type: "error",
...
var earnMerkleRewardDistributor = [
	{
		type: "constructor",
		inputs: [
			{
...
var earnRouter = [
	...
	{
		type: "error",
		name: "InvalidPrivateAsset",
		inputs: []
	},
	{
		type: "error",
		name: "InvalidReturnToken",
		inputs: []
	},
	{
		type: "error",
		name: "InvalidRoutePair",
		inputs: []
	},
	{
		type: "error",
		name: "InvalidSourcePortal",
		inputs: []
	},
	{
		type: "error",
...
var earnVault = [
	...
	},
	{
		...
		inputs: [
			...
			{
				name: "minNewEngineShares",
				type: "uint256"
			},
			{
				name: "minAssetsRetained",
				type: "uint256"
			}
		],
		outputs: [{
			name: "newEngineShares",
			type: "uint256"
		}],
		stateMutability: "nonpayable"
	},
	...
	{
		type: "error",
		name: "ActiveSupplyWithoutBacking",
		inputs: []
	},
	{
		type: "error",
	...
	{
		type: "error",
		name: "DistributorFeeUpdateNotPending",
		inputs: []
	},
	{
		type: "error",
	...
	{
		type: "error",
		name: "DistributorTransferNotPending",
		inputs: []
	},
	{
		type: "error",
	...
	{
		type: "error",
		name: "EngineEarnVaultMismatch",
		inputs: []
	},
	{
		type: "error",
		name: "EngineExitUnsupported",
		inputs: []
	},
	{
		type: "error",
		name: "ExceedsMaxEarnShares",
		inputs: []
	},
	{
		type: "error",
	...
	},
	{
		...
		inputs: [{
			name: "expectedManagedAssets",
			type: "uint256"
		}, {
			name: "actualManagedAssets",
			type: "uint256"
		}]
	},
	{
		type: "error",
		name: "FeeValuationStale",
		inputs: []
	},
	{
		type: "error",
	...
	{
		type: "error",
		name: "GlobalFeeDisableUnavailable",
		inputs: []
	},
	{
		type: "error",
		name: "InitialEarnShareSupplyNotZero",
		inputs: []
	},
	{
		type: "error",
	...
	{
		type: "error",
		name: "InvalidDistributorConfiguration",
		inputs: []
	},
	{
		type: "error",
		name: "InvalidDistributorFeeConfiguration",
		inputs: []
	},
	{
		type: "error",
		name: "InvalidEarnDecimals",
		inputs: []
	},
	{
		type: "error",
		name: "InvalidEngineShareScale",
		inputs: []
	},
	{
		type: "error",
	...
	},
	{
		...
		inputs: [{
			name: "minimumEarnShares",
			type: "uint256"
		}, {
			name: "actualEarnShares",
			type: "uint256"
		}]
	},
	{
		...
		inputs: [{
			name: "minimumEngineShares",
			type: "uint256"
		}, {
			name: "actualEngineShares",
			type: "uint256"
		}]
	},
	{
	...
	{
		type: "error",
		name: "NotEmergencyGuardianOrOperator",
		inputs: []
	},
	{
		type: "error",
	...
	{
		type: "error",
		name: "NotPendingDistributor",
		inputs: []
	},
	{
		type: "error",
		name: "NotRequesterOrJanitor",
		inputs: []
	},
	{
		type: "error",
		name: "OperatorMigrationDisabled",
		inputs: []
	},
	{
		type: "error",
		name: "PendingRedeemsOpen",
		inputs: []
	},
	{
		type: "error",
...
var erc4626Engine = [
	...
	{
		type: "error",
		name: "InvalidVenueShareDecimals",
		inputs: []
	},
	{
		type: "error",
		name: "NoVenueSharesReceived",
		inputs: []
	},
	{
		type: "error",
...
var vedaEngine = [
	...
	{
		type: "error",
		name: "NoPublishedVedaPeriphery",
		inputs: []
	},
	{
		type: "error",
		name: "NoRecoverableClaims",
		inputs: []
	},
	{
		type: "error",
...
var zoneOutbox = [
	...
	{
		name: "InvalidFallbackRecipient",
		type: "error",
		inputs: []
	},
	{
		name: "CallbackDataTooLarge",
		type: "error",
		inputs: []
	},
	{
	...
	{
		name: "TooManyWithdrawalsThisBlock",
		type: "error",
		inputs: []
	},
	{
		name: "InvalidRevealTo",
		type: "error",
		inputs: []
	},
	{
		name: "InvalidCurrentTxHash",
		type: "error",
		inputs: []
	},
	{
...
var zoneVerifier = [{
	...
	inputs: [
		...
		{
			type: "uint64",
			name: "expectedWithdrawalBatchIndex"
		},
		{
			type: "tuple",
			name: "blockTransition",
...
function deserialize(serializedTransaction) {
	const type = slice(serializedTransaction, 0, 1);
...
async function serialize(transaction, signature) {
	if (!isTempo(transaction)) {
		...
		if (signature && "type" in signature) {
			...
			return serializeTransaction$4(transaction, {
...
function deserializeTempo(serializedTransaction) {
	const { feePayerSignature, nonce, ...tx } = deserialize$1(serializedTransaction);
	return {
		...tx,
...
async function serializeTempo(transaction, sig) {
	const signature_provided = (() => {
		...
		if (sig) return from$4({
			r: BigInt(sig.r),
			s: BigInt(sig.s),
			yParity: Number(sig.yParity)
		});
	})();
	const { chainId, feePayer, multisigSimulation, nonce, owner: _owner, ...rest } = transaction;
	...
	const hasSenderSignature = typeof signature_provided !== "undefined" || Boolean(multisigSimulation && transaction.signatures);
	const shouldStripFeeTokenForSponsorship = feePayer === true && (!hasSenderSignature || !feePayerSignature) || typeof feePayer === "object" && !hasSenderSignature || !hasSenderSignature && hasPrefilledFeePayerSignature;
	...
	const signature = (() => {
		...
		if (!multisigSimulation || !transaction.signatures) return void 0;
		const payload = getSignPayload(from$1(transaction_sender_ox));
		const signatures = transaction.signatures.map((approval) => from$4(approval));
		const config = from$5(multisigSimulation.config);
		const account = multisigSimulation.account;
		return from$4({
			account,
			config,
			signatures: sortMultisigApprovals({
				account,
				config,
				payload,
				signatures
	...
	if (signature && typeof transaction.feePayer === "object") {
		const tx = from$1(transaction_ox, { signature });
		const hash = getFeePayerSignPayload(tx, { sender: transaction.from ?? extractAddress({
			payload: getSignPayload(tx),
			root: true,
			signature
		}) });
		const feePayerSignature = await transaction.feePayer.sign({ hash });
		return serialize$1(tx, { feePayerSignature: from$11(feePayerSignature) });
	}
	if (feePayer === true || !signature && hasPrefilledFeePayerSignature) {
		if (signature && feePayerSignature) return serialize$1(transaction_sender_ox, { signature });
		if (signature) return serialize$1(transaction_sender_ox, {
			format: "feePayer",
			sender: transaction.from,
			signature
		});
		return serialize$1(transaction_sender_ox, { feePayerSignature: null });
	}
	return serialize$1(transaction_sender_ox, {
...
function fromMultisig(value) {
	...
	const config = (() => {
		if (!configInput) return void 0;
		const ownerEntries = configInput.owners.map((value) => typeof value === "string" || "address" in value ? {
			owner: value,
			weight: 1
		} : value);
		return from$5({
	...
	if (typeof value !== "string") {
		if ((value.address === void 0 || value.address === "infer") && config.version !== 0n) throw new Error("An initial multisig config must have version zero.");
		if (value.address !== void 0 && value.address !== "infer" && config.version === 0n) throw new Error("A current multisig config must have a version.");
	}
	const address = checksum((() => {
		if (typeof value === "string") return value;
		if (value.address === void 0 || value.address === "infer") return getAddress(config);
		return value.address;
	})());
	const ownerAccounts = (() => {
		if (!configInput) return [];
		return configInput.owners.flatMap((value) => {
			const owner = typeof value === "string" || "address" in value ? value : value.owner;
			return typeof owner === "string" ? [] : [parseAccount(owner)];
		});
	})();
	const owners = config?.owners.flatMap(({ owner }) => {
		const account = ownerAccounts.find((account) => isEqual$2(account.address, owner));
	...
	const account = {
		...
		type: "local",
		async sign({ hash }) {
			return serialize$3(await signMultisig(account, { payload: hash }));
		},
		async signMessage() {
		...
		async signTransaction(transaction, options) {
			...
			if (request.owner) {
				...
				if (owner.type !== "local") throw new Error("A local owner account is required to approve a multisig transaction.");
				if (owner.source !== "root" && owner.source !== "multisig") throw new Error("A Tempo owner account is required to approve a multisig transaction.");
				const { owner: _, ...ownerRequest } = request;
				return await owner.signTransaction(ownerRequest, options);
			}
			if (owners.length === 0) return await serializer(transaction);
			const presign = {
				...request,
				signatures: void 0,
				...request.feePayerSignature === void 0 ? {} : { feePayerSignature: null }
			};
			...
			if (!isEqual$2(requestAccount, address)) {
				if (!simulation) throw new Error("A multisig config is required for local signing.");
				const parentDigest = getSignPayload$2({
					account: requestAccount,
					config: from$5(simulation.config),
					payload
				});
				return serialize$3(await signMultisig(account, { payload: parentDigest }));
			}
			return await serializer(transaction, await signMultisig(account, {
				config: simulation?.config,
				payload,
				signatures: request.signatures?.map((signature) => from$4(signature))
			}));
		},
		async signTypedData() {
...
async function signMultisig(account, parameters) {
	const { config, payload, signatures: providedSignatures = [] } = parameters;
	const currentConfig = config ?? account.config;
	if (!currentConfig) throw new Error("A current multisig config is required for local signing.");
	const digest = getSignPayload$2({
	...
	const signedOwners = /* @__PURE__ */ new Set();
	let weight = 0;
	for (const signature of providedSignatures) {
		...
		const owner = currentConfig.owners.find((owner) => isEqual$2(owner.owner, address));
		if (!owner || signedOwners.has(address)) continue;
		signedOwners.add(address);
		weight += Number(owner.weight);
	}
	const owners = [...currentConfig.owners].sort((a, b) => Number(b.weight) - Number(a.weight) || a.owner.toLowerCase().localeCompare(b.owner.toLowerCase()));
	for (const owner of owners) {
		const address = owner.owner.toLowerCase();
		if (signedOwners.has(address)) continue;
		const ownerAccount = account.owners.find((account) => isEqual$2(account.address, owner.owner));
		if (!ownerAccount) continue;
		if (isMultisigAccount(ownerAccount)) signatures.push(await signMultisig(ownerAccount, { payload: digest }));
		else {
			if (!ownerAccount.sign) throw new Error("Multisig owner account cannot sign.");
			signatures.push(from$4(await ownerAccount.sign({ hash: digest })));
		}
		signedOwners.add(address);
		weight += Number(owner.weight);
		if (weight >= Number(currentConfig.threshold)) break;
	}
	if (weight < Number(currentConfig.threshold)) throw new Error("Local multisig owners do not meet the threshold.");
	return from$4({
		account: account.address,
		config: currentConfig,
		signatures: sortMultisigApprovals({
...
/** @internal */
function getKeyAuthorizationSignPayload(account, parameters) {
	const { admin, chainId, expiry, key, limits, scopes, witness } = parameters;
	const { accessKeyAddress, keyType: type } = resolveAccessKey(key);
	const boundFields = isAccessKeyAccount(account) || isMultisigAccount(account) ? { account: account.address } : {};
	const restrictions = admin ? {} : {
		expiry,
		limits,
		scopes
	};
	return getSignPayload$1({
...
async function signKeyAuthorization(account, parameters) {
	const { admin, chainId, expiry, key, limits, multisig: multisigState, scopes, signatures, witness } = parameters;
	const { accessKeyAddress, keyType: type } = resolveAccessKey(key);
	const isAccessKey = isAccessKeyAccount(account);
	const isMultisig = isMultisigAccount(account);
	const boundFields = isAccessKey || isMultisig ? { account: account.address } : {};
	const restrictions = admin ? {} : {
		expiry,
		limits,
		scopes
	...
	return from$2({
		address: accessKeyAddress,
		chainId,
		signature: from$4(await (async () => {
			if (isAccessKey) return account.sign({
				hash,
				raw: true
			});
			if (isMultisig) {
				if (!multisigState) throw new Error("Multisig state is required to sign a key authorization.");
				return serialize$3(await signMultisig(account, {
					config: multisigState.config,
					payload: hash,
					signatures: signatures?.map((signature) => from$4(signature))
				}));
			}
...
var nativeMultisig = "0xAACC000000000000000000000000000000000000";
...
//#endregion
//#region node_modules/viem/_esm/tempo/actions/multisig.js
/**
...
async function getConfig(client, parameters) {
	...
	return config ? fromRpc$5(config) : null;
}
/**
...
(function(getConfigCommitment) {
	...
	*/
	function call(args) {
		return defineCall({
			address: nativeMultisig,
			abi: nativeMultisig$1,
			args: [args.account],
			functionName: "getConfigCommitment"
		});
	}
	getConfigCommitment.call = call;
})(getConfigCommitment || (getConfigCommitment = {}));
/**
...
(function(updateConfig) {
	...
	async function inner(action, client, parameters) {
		...
		const account = (() => {
			if (typeof accountValue === "object" && accountValue.source === "multisig") return accountValue;
		})();
		const config = (() => {
		...
		const currentConfig = await (async () => {
			if (config) return from$5(config);
			if (!address) throw new Error("A multisig account address or current config is required.");
			const cachedConfig = await getConfig(client, { address });
			if (!cachedConfig) throw new Error(`No current multisig config is cached for account ${address}. Provide the current config.`);
			return cachedConfig;
		})();
		const resolvedAccount = (() => {
			...
			if (address) return fromMultisig({
				address,
				...currentConfig
			});
		})();
	...
	*/
	function call(args) {
		const currentConfig = from$5(args.currentConfig);
		const nextConfig = from$5({
...
async function prepareAuthorization(client, parameters) {
	...
	const multisigState = await (async () => {
		...
		if (parsed.source !== "multisig") return void 0;
		const account = parsed;
		if (!account.config) throw new Error("A multisig config is required to prepare a key authorization.");
	...
	const signPayload = parsed.source === "multisig" && multisigState ? getSignPayload$2({
...
async function signAuthorization(client, parameters) {
	if ("hash" in parameters && parameters.hash || "owner" in parameters && parameters.owner) {
		const parameters_ = parameters;
		const owner_ = parameters_.owner;
		if (!owner_ || typeof owner_ === "string") throw new Error("A local owner account is required to approve a multisig key authorization.");
		const sign = parseAccount(owner_).sign;
		if (!sign) throw new Error("A local owner account is required to approve a multisig key authorization.");
		const request = await (async () => {
			if ("hash" in parameters_ && parameters_.hash) {
				const signature = serialize$3(from$4(await sign({ hash: parameters_.hash })));
				return {
					hash: parameters_.hash,
					signature
				};
			}
			...
			const config = await (async () => {
				if (typeof account_ !== "string" && account_.config) return account_.config;
			...
			const account = (() => {
				if (config.version !== 0n) return fromMultisig({
					address,
					...config
				});
			...
			if (!isAddressEqual(account.address, address)) throw new Error("Initial multisig config does not match the account.");
			const prepared = await prepareAuthorization(client, {
				...authorization,
				account
			});
			const signature = serialize$3(from$4(await sign({ hash: prepared.signPayload })));
			...
			return { keyAuthorization: toRpc$2(from$2({
				account: account.address,
				address: accessKeyAddress,
				chainId: BigInt(chainId),
				signature: from$4({
		...
		const multisig = fromRpc$1(await client.request({
			method: "multisig_approveKeyAuthorization",
			params: [request]
		}));
		const keyAuthorization = deserialize$2(await (async () => {
			...
			return serializeKeyAuthorization(multisig.keyAuthorization, {
				account: multisig.account,
				approvals: approvals.selectedApprovals.length > 0 ? approvals.selectedApprovals : approvals.approvals.slice(0, 1),
				config: multisig.config
			});
		})());
		if (!keyAuthorization.signature) throw new Error("Expected a signed multisig key authorization.");
		return {
			...keyAuthorization,
			hash: multisig.hash,
			multisig,
	...
	const { accessKey, account: account_, chainId, multisig: multisigState, signPayload: _, ...rest } = "signPayload" in parameters ? parameters : await prepareAuthorization(client, parameters);
...
function formatTransactionReceipt(receipt) {
	return {
		...formatTransactionReceipt$1(receipt),
...
function formatMultisig(value) {
	...
	const operation = fromRpc$1(value);
	if (operation.type !== "transaction") throw new Error("Expected a multisig transaction operation.");
	return operation;
}
function formatTransactionRequest(r, action) {
	const request = r;
	const account = request.account ? parseAccount(request.account) : void 0;
	const owner = request.owner ? parseAccount(request.owner) : void 0;
	if (owner?.type === "json-rpc") throw new Error("A local owner account is required to approve a multisig transaction.");
	...
	const keyId = signer && "accessKeyAddress" in signer ? signer.accessKeyAddress : request.keyId;
...
var serializeTransaction = ((transaction, signature) => serialize(transaction, signature));
var chainConfig = {
	blockTime: 1e3,
	...
	prepareTransactionRequest: [async (r, { client, phase }) => {
		const request = r;
		if (request.hash) {
			if (!request.account || typeof request.account === "string" || request.account.source !== "multisig") throw new Error("A local multisig account is required to approve a stored multisig transaction.");
			if (!request.owner || typeof request.owner === "string") throw new Error("A local owner account is required to approve a stored multisig transaction.");
			if (request.owner.source !== "root" && request.owner.source !== "multisig") throw new Error("A Tempo owner account is required to approve a stored multisig transaction.");
			const transaction = await getAction(client, getTransaction, "getTransaction")({ hash: request.hash });
			const operation = "multisig" in transaction ? transaction.multisig : void 0;
			if (!operation) throw new Error("Expected a multisig operation transaction.");
			if (!isAddressEqual(operation.account, request.account.address)) throw new Error("Multisig operation account does not match the requested account.");
			const storedTransaction = deserialize(operation.transaction);
			if (getHash({
				account: operation.account,
				config: operation.config,
				transaction: operation.transaction,
				type: "transaction"
			}).toLowerCase() !== request.hash.toLowerCase()) throw new Error("Multisig operation hash does not match transaction.");
			return {
				...storedTransaction,
				account: request.account,
		...
		if (phase === "afterFillParameters") {
			if (typeof request.gas !== "undefined" && request.feePayer && !request.feePayerSignature) {
		...
		const multisigIdentity = (() => {
			if (request.account?.source === "multisig") return {
				account: request.account.address,
				config: request.account.config,
				local: request.account
			};
		})();
		if (request.owner && !multisigIdentity) throw new Error("A multisig account is required when an owner is provided.");
		if (request.owner && typeof request.owner === "string") throw new Error("A local owner account is required to approve a multisig transaction.");
		if (request.owner && request.owner.source !== "root" && request.owner.source !== "multisig") throw new Error("A Tempo owner account is required to approve a multisig transaction.");
		const coordinatedMultisig = !!multisigIdentity && !!request.owner && client.transport.multisig === true;
		if (multisigIdentity) {
			const { account, local } = multisigIdentity;
			if (!account) throw new Error("A multisig account address is required with a current config.");
			const config = await (async () => {
				if (multisigIdentity.config) return multisigIdentity.config;
				if (!coordinatedMultisig) return void 0;
				const cachedConfig = await getAction(client, getConfig, "getConfig")({ address: account });
				if (!cachedConfig) throw new Error(`No current multisig config is cached for account ${account}. Provide the current config.`);
				return cachedConfig;
			})();
			if (!config) throw new Error("A multisig config is required to prepare a transaction.");
		...
		const useExpiringNonce = await (async () => {
			if (request.nonceKey === "expiring" || request.nonceKey === maxUint256) return true;
			...
			if (address && typeof request.nonceKey === "undefined") return await detect(address.toLowerCase());
			return false;
		})();
		if (coordinatedMultisig && typeof request.nonceKey === "undefined") {
			request.nonceKey = toBigInt(random(31)) + 1n;
			request.nonce = 0;
		} else if (useExpiringNonce) {
			request.nonceKey = maxUint256;
			request.nonce = 0;
			if (typeof request.validAfter === "undefined") request.validAfter = randomValidAfter();
	...
	serializers: {
		...
		async transactionEnvelope({ serializedTransaction, transaction }) {
			...
			try {
				deserialize$3(serializedTransaction);
			} catch {
				if (deserialize(serializedTransaction).signature?.type === "multisig") return serializedTransaction;
	...
	async verifyHash(client, parameters) {
		...
		const envelope = (() => {
			...
			try {
				return deserialize$3(signature);
			} catch {
				return;
			}
		})();
...
function getMultisigSimulation(options) {
	...
	return {
		...
		approvals: selectOwners(config).map((owner) => {
			const localOwner = local?.owners.find((account) => isAddressEqual(account.address, owner.owner));
			if (localOwner?.source === "multisig") {
				const nested = localOwner;
				if (!nested.config) throw new Error("A nested multisig config is required for gas estimation.");
				return {
					type: "multisig",
					spec: {
						account: nested.address,
						approvals: selectOwners(nested.config).map((owner) => {
							const nestedOwner = nested.owners.find((account) => isAddressEqual(account.address, owner.owner));
							if (nestedOwner?.source === "multisig") throw new Error("Multisig simulation nesting exceeds depth two.");
							return {
...
function getSimulationKey(account) {
	const keyType = (() => {
		if (account && typeof account === "object" && "keyType" in account && typeof account.keyType === "string") return account.keyType;
	})();
	if (!keyType || keyType === "webAuthn") return {
		keyData: "0x0578",
		keyType: "webAuthn"
	};
...
function randomValidAfter() {
	const latest = BigInt(Math.floor(Date.now() / 1e3)) - 60n;
	if (latest <= 0n) return 0;
	return Number(BigInt(random(8)) % latest);
}
/** Selects a deterministic minimum-cardinality owner quorum. */
function selectOwners(config) {
	const owners = [...config.owners].sort((a, b) => Number(b.weight) - Number(a.weight) || a.owner.toLowerCase().localeCompare(b.owner.toLowerCase()));
	const selected = [];
	let weight = 0;
...
var tempo = /*#__PURE__*/ defineChain({
	...
	contracts: {
		earnFactory: { address: "0xb5889A96114014d4C032ebD76772c10bF3b97137" },
		erc4626EngineFactory: { address: "0xd43D00981222a8db444A528E69f19E3cE5A7D2Ff" }
	},
	name: "Tempo Mainnet",
	nativeCurrency: {
		name: "USD",
...
var unichain = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$9]: { address: "0x2F12d621a16e2d3285929C9996f478508951dFe4" } },
		portal: { [sourceId$9]: { address: "0x0bd48f6B86a26D3a217d0Fa6FfE2B491B956A7a2" } },
		l1StandardBridge: { [sourceId$9]: { address: "0x81014F44b0a345033bB2b3B21C7a1A308B35fEeA" } }
	},
	sourceId: sourceId$9
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/unichainSepolia.js
var sourceId$8 = 11155111;
var unichainSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		portal: { [sourceId$8]: { address: "0x0d83dab629f0e0F9d36c0Cbc89B69a489f0751bD" } },
		l1StandardBridge: { [sourceId$8]: { address: "0xea58fcA6849d79EAd1f26608855c2D6407d54Ce2" } },
		disputeGameFactory: { [sourceId$8]: { address: "0xeff73e5aa3B9AEC32c659Aa3E00444d20a84394b" } }
	},
	testnet: true,
	sourceId: sourceId$8
});
...
var whitechainSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" },
		disputeGameFactory: { [sourceId$7]: { address: "0xfaa2fAA8912C069c01abc169c33713c79027c833" } },
		portal: { [sourceId$7]: {
			address: "0xFF9b597b0781457ae6aa7256Ca5ed5839bF7D0C3",
			blockCreated: 11071328
		} },
		l1StandardBridge: { [sourceId$7]: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xgrTestnet.js
var xgrTestnet = /*#__PURE__*/ defineChain({
	id: 1879,
	name: "XGR Testnet",
	nativeCurrency: {
		name: "XGR",
	...
	rpcUrls: { default: { http: ["https://rpc1.testnet.xgr.network"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ynxTestnet.js
var ynxTestnet = /*#__PURE__*/ defineChain({
	id: 6423,
	name: "YNX Testnet",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://evm.ynxweb4.com"] } },
	blockExplorers: { default: {
		name: "YNX Explorer",
...
//#endregion
export { whitechainSepolia as $, metis as $a, gnosis as $c, bitlayerTestnet as $d, apeChain as $f, optopiaTestnet as $i, eosTestnet as $l, skaleNebulaTestnet as $n, lavita as $o, rise as $r, initVerse as $s, taraxa as $t, creditCoin3Testnet as $u, xrSepolia as A, morphTachyonTestnet as Aa, haustTestnet as Ac, btrTestnet as Ad, auroraTestnet as Af, polygon as Ai, flowMainnet as Al, stable as An, lyra as Ao, scrollSepolia as Ar, juneoEUR1Chain as As, tronNile as At, disChain as Au, xLayerTestnet as B, monad as Ba, guruTestnet as Bc, bounceBit as Bd, artelaTestnet as Bf, plasmaDevnet as Bi, fantom as Bl, songbird as Bn, localhost as Bo, rss3Sepolia as Br, jbc as Bs, that as Bt, datahavenTestnet as Bu, zetachain as C, neoxMainnet as Ca, hemiSepolia as Cc, celoSepolia as Cd, bahamut as Cf, polynomialSepolia as Ci, fluentDevnet as Cl, storyTestnet as Cn, mantleSepoliaTestnet as Co, shape as Cr, juneoUSD1Chain as Cs, unichain as Ct, dreyerxMainnet as Cu, yooldoVerseTestnet as D, near as Da, hederaTestnet as Dc, cannon as Dd, avalanche as Df, polygonZkEvm as Di, fluence as Dl, step as Dn, manta as Do, seiTestnet as Dr, juneoLTC1Chain as Ds, ultra as Dt, domaTestnet as Du, zenchainTestnet as E, nearTestnet as Ea, hela as Ec, canto as Ed, avalancheFuji as Ef, polygonZkEvmCardona as Ei, fluenceStage as El, story as En, mantaSepoliaTestnet as Eo, sentrix as Er, juneomBTC1Chain as Es, ultraTestnet as Et, donatuz as Eu, xpla as F, moonriver as Fa, hardhat as Fc, bscGreenfield as Fd, astar as Ff, plumeDevnet as Fi, filecoinCalibration as Fl, sophon as Fn, lumiaTestnet as Fo, sapphire as Fr, jovaySepolia as Fs, tiktrixTestnet as Ft, defichainEvmTestnet as Fu, xdc as G, mintSepoliaTestnet as Ga, graphiteTestnet as Gc, bobaSepolia as Gd, arcTestnet as Gf, pgn as Gi, evmosTestnet as Gl, snaxTestnet as Gn, lineaSepolia as Go, root as Gr, iotex as Gs, tempoLocalnet as Gt, cyber as Gu, xgrTestnet as H, mode as Ha, gunz as Hc, botanix as Hd, areonNetworkTestnet as Hf, planq as Hi, exsat as Hl, soneium as Hn, liskSepolia as Ho, rootstockTestnet as Hr, jasmyChain as Hs, ternoa as Ht, dailyNetworkTestnet as Hu, xphereTestnet as I, moonbeamDev as Ia, haqqTestedge2 as Ic, bsc as Id, assetChainTestnet as If, plume as Ii, filecoin as Il, sonicTestnet as In, lumiaMainnet as Io, sanko as Ir, jovay as Is, thunderTestnet as It, defichainEvm as Iu, worldLand as J, mezo as Ja, godwoken as Jc, blastSepolia as Jd, arbitrumNova as Jf, palmTestnet as Ji, ethernity as Jl, skaleTitanTestnet as Jn, lightlinkPhoenix as Jo, rollux as Jr, inkSepolia as Js, telosTestnet as Jt, crossbell as Ju, xaiTestnet as K, mint as Ka, graphite as Kc, boba as Kd, arc as Kf, peaq as Ki, evmos as Kl, snax as Kn, lineaGoerli as Ko, ronin as Kr, iotaTestnet as Ks, tempoDevnet as Kt, curtis as Ku, xphereMainnet as L, moonbeam as La, haqqMainnet as Lc, bronosTestnet as Ld, assetChain as Lf, plinga as Li, fibo as Ll, sonicBlazeTestnet as Ln, luksoTestnet as Lo, saigon as Lr, jocTestnet as Ls, thunderCore as Lt, dchainTestnet as Lu, xrplevmDevnet as M, morphSepolia as Ma, hashkeyTestnet as Mc, bsquaredTestnet as Md, atletaOlympia as Mf, plumeTestnet as Mi, flare as Ml, sovaSepolia as Mn, luxeports as Mo, satoshiVMTestnet as Mr, juneoDAI1Chain as Ms, treasureTopaz as Mt, dfk as Mu, xrplevm as N, morphHolesky as Na, hashkey as Nc, bsquared as Nd, astarZkyoto as Nf, plumeSepolia as Ni, flame as Nl, sova as Nn, lumozTestnet as No, satoshiVM as Nr, juneoBCH1Chain as Ns, treasure as Nt, degen as Nu, yooldoVerse as O, nautilus as Oa, hederaPreviewnet as Oc, bxnTestnet as Od, autheoTestnet as Of, polygonMumbai as Oi, flowTestnet as Ol, statusSepolia as On, mandala as Oo, seismicDevnet as Or, juneoLINK1Chain as Os, ubiq as Ot, dogechain as Ou, xrOne as P, morph as Pa, harmonyOne as Pc, bscTestnet as Pd, astarZkEVM as Pf, plumeMainnet as Pi, filecoinHyperspace as Pl, sophonTestnet as Pn, lumoz as Po, sapphireTestnet as Pr, juneo as Ps, tomb as Pt, defiOracleMetaMainnet as Pu, whitechainTestnet as Q, metisGoerli as Qa, gnosisChiado as Qc, bitrock as Qd, apexTestnet as Qf, orderly as Qi, eteria as Ql, skaleRazor as Qn, lens as Qo, riseTestnet as Qr, initVerseGenesis as Qs, taraxaTestnet as Qt, cronos as Qu, xoneTestnet as R, moonbaseAlpha as Ra, happychainTestnet as Rc, bronos as Rd, artheraTestnet as Rf, playfiAlbireo as Ri, fantomTestnet as Rl, sonic as Rn, lukso as Ro, saga as Rr, jocMainnet as Rs, thetaTestnet as Rt, dchain as Ru, zetachainAthensTestnet as S, neoxT4 as Sa, henesys as Sc, chang as Sd, basePreconf as Sf, potos as Si, fluentTestnet as Sl, stratis as Sn, mantleTestnet as So, defineChain as Sp, shapeSepolia as Sr, juneoUSDT1Chain as Ss, unichainSepolia as St, dreyerxTestnet as Su, zeniq as T, neonDevnet as Ta, heliosTestnet as Tc, celo as Td, b3 as Tf, polygonZkEvmTestnet as Ti, fluenceTestnet as Tl, storyAeneid as Tn, mantaTestnet as To, sentrixTestnet as Tr, juneoSGD1Chain as Ts, ultron as Tt, dosChain as Tu, xgr as U, mizuhikiTestnetAwaji as Ua, gravity as Uc, boolBetaMainnet as Ud, areonNetwork as Uf, phoenix as Ui, expanse as Ul, somniaTestnet as Un, lisk as Uo, rootstock as Ur, iSunCoin as Us, tenet as Ut, dailyNetwork as Uu, xLayer as V, modeTestnet as Va, guruNetwork as Vc, botanixTestnet as Vd, areum as Vf, plasma as Vi, exsatTestnet as Vl, soneiumMinato as Vn, loadAlphanet as Vo, rss3 as Vr, jasmyChainTestnet as Vs, thaiChain as Vt, darwinia as Vu, xdcTestnet as W, mitosisTestnet as Wa, grav as Wc, bobSepolia as Wd, arenaz as Wf, pgnTestnet as Wi, excelonMainnet as Wl, somnia as Wn, lineaTestnet as Wo, rootPorcini as Wr, iotexTestnet as Ws, tempoModerato as Wt, cyberTestnet as Wu, worldchain as X, mev as Xa, gobi as Xc, bitTorrentTestnet as Xd, arbitrum as Xf, otimDevnet as Xi, etherlinkShadownetTestnet as Xl, skaleBaseSepoliaTestnet as Xn, lestnet as Xo, robinhood as Xr, injectiveTestnet as Xs, telcoinTestnet as Xt, cronoszkEVM as Xu, worldchainSepolia as Y, mevTestnet as Ya, goChain as Yc, blast as Yd, arbitrumGoerli as Yf, palm as Yi, etherlinkTestnet as Yl, skaleTitan as Yn, lightlinkPegasus as Yo, robinhoodTestnet as Yr, ink as Ys, telos as Yt, cronoszkEVMTestnet as Yu, wmcTestnet as Z, metisSepolia as Za, goat as Zc, bitTorrent as Zd, apollo as Zf, orderlySepolia as Zi, etherlink as Zl, skaleBase as Zn, lensTestnet as Zo, rivalz as Zr, injective as Zs, teaSepolia as Zt, cronosTestnet as Zu, zircuitGarfieldTestnet as _, nitrographTestnet as _a, hpp as _c, citreaTestnet as _d, baseSepolia as _f, pumpfiTestnet as _i, foundry as _l, superseedSepolia as _n, marsCredit as _o, fireChain as _p, shiden as _r, kardiaChain as _s, valygoNft as _t, edexaTestnet as _u, zkXPLA as a, opBNBTestnet as aa, icbNetwork as ac, cornTestnet as ad, bifrost as af, redbellyTestnet as ai, genesys as al, taiko as an, metachain as ao, alienx as ap, skaleCryptoColosseum as ar, kroma as as, wanchainTestnet as at, energy as au, zilliqa as b, nexi as ba, hoodi as bc, chips as bd, basecampTestnet as bf, premiumBlockTestnet as bi, forma as bl, superlumio as bn, mantraEVM as bo, zeroGGalileoTestnet as bp, shardeumSphinx as br, kairos as bs, uniqueOpal as bt, dymension as bu, zksyncLocalHyperchainL1 as c, oneWorld as ca, hychainTestnet as cc, coreTestnet1 as cd, berachainTestnet as cf, reactiveTestnet as ci, garnet as cl, syscoinTestnet as cn, formicarium as co, aioz as cp, skaleCalypso as cr, klaytn as cs, vision as ct, electroneum as cu, zksyncInMemoryNode as d, omax as da, humanode as dc, confluxESpace as dd, bearNetworkChainTestnet as df, quaiTestnet as di, fuseSparknet as dl, swellchainTestnet as dn, mekong as do, adf as dp, siliconSepolia as dr, kii as ds, velas as dt, eduChainTestnet as du, optopia as ea, inEVM as ec, creditCoin3Mainnet as ed, bitlayer as ef, reyaNetwork as ei, glideL2Protocol as el, taikoTestnetSepolia as en, meterTestnet as eo, anvil as ep, skaleNebula as er, ladyChain as es, whitechain as et, eos as eu, zksync as f, okc as fa, humanityTestnet as fc, coinex as fd, bearNetworkChainMainnet as ff, quai as fi, fuse as fl, swellchain as fn, megaethTestnet as fo, acria as fp, silicon as fr, kcc as fs, vechain as ft, eduChain as fu, zkFair as g, nomina as ga, hppSepolia as gc, classic as gd, battlechain as gf, pyrope as gi, fraxtal as gl, surgeTestnet as gn, matchain as go, abey as gp, shimmer as gr, karura as gs, valygoSmartchain as gt, edgeless as gu, zkFairTestnet as h, oasisTestnet as ha, huddle01Mainnet as hc, codex as hd, battlechainTestnet as hf, ql1 as hi, fraxtalTestnet as hl, swan as hn, matchainTestnet as ho, abstract as hp, shimmerTestnet as hr, katana as hs, vana as ht, edgelessTestnet as hu, zkXPLATestnet as i, openledger as ia, idchain as ic, cpchain as id, birdlayer as if, reddio as ii, gensyn as il, taikoHekla as in, metachainIstanbul as io, alienxHalTestnet as ip, skaleEuropa as ir, kromaSepolia as is, weaveVMAlphanet as it, eni as iu, xrplevmTestnet as j, morphTachyon as ja, hausTestnet as jc, btr as jd, aurora as jf, polterTestnet as ji, flareTestnet as jl, spicy as jn, lycan as jo, scroll as jr, juneoDOGE1Chain as js, tron as jt, diode as ju, ynxTestnet as k, nahmii as ka, hedera as kc, bxn as kd, auroria as kf, polygonAmoy as ki, flowPreviewnet as kl, stableTestnet as kn, mainnet as ko, sei as kr, juneoGLD1Chain as ks, tronShasta as kt, dodochainTestnet as ku, zksyncLocalHyperchain as l, omniOmega as la, hychain as lc, coreDao as ld, berachainBepolia as lf, radiusTestnet as li, fusionTestnet as ll, syscoin as ln, memecore as lo, agungTestnet as lp, skaleBlockBrawlers as lr, kinto as ls, victionTestnet as lt, elastosTestnet as lu, zkLinkNova as m, oasys as ma, huddle01Testnet as mc, codexTestnet as md, beam as mf, qMainnet as mi, funkiMainnet as ml, swanProximaTestnet as mn, mchVerse as mo, abstractTestnet as mp, sidraChain as mr, kava as ms, vanaMoksha as mt, edgeware as mu, zoraSepolia as n, optimismGoerli as na, immutableZkEvm as nc, creatorTestnet as nd, bitkub as nf, redstone as ni, giwaSepolia as nl, taikoJolnir as nn, metalL2 as no, ancient8 as np, skaleExorde as nr, l3x as ns, wemixTestnet as nt, enuls as nu, zksyncSepoliaTestnet as o, opBNB as oa, hyperliquidEvmTestnet as oc, corn as od, bevmMainnet as of, redbellyMainnet as oi, geist as ol, tacSPB as on, merlinErigonTestnet as oo, alephZeroTestnet as op, skaleCryptoBlades as or, koi as os, wanchain as ot, elysiumTestnet as ou, zkLinkNovaSepoliaTestnet as p, odysseyTestnet as pa, humanity as pc, coinbit as pd, beamTestnet as pf, qTestnet as pi, funkiSepolia as pl, swanSaturnTestnet as pn, megaeth as po, acala as pp, silentData as pr, kavaTestnet as ps, vanar as pt, edgewareTestnet as pu, xai as q, mezoTestnet as qa, goerli as qc, bob as qd, arbitrumSepolia as qf, paseoPassetHub as qi, etp as ql, sketchpad as qn, linea as qo, rolluxTestnet as qr, iota as qs, tempo as qt, crossfi as qu, zora as r, optimism as ra, igra as rc, crab as rd, bitgert as rf, reddioSepolia as ri, giwaSepoliaPreconf as rl, taikoHoodi as rn, metadium as ro, alpenTestnet as rp, skaleEuropaTestnet as rr, krown as rs, wemix as rt, eniTestnet as ru, zksyncLocalNode as s, oortMainnetDev as sa, hyperEvm as sc, coreTestnet2 as sd, berachainTestnetbArtio as sf, real as si, gatechain as sl, tac as sn, merlin as so, alephZero as sp, skaleCalypsoTestnet as sr, klaytnBaobab as ss, visionTestnet as st, electroneumTestnet as su, zoraTestnet as t, optimismSepolia as ta, immutableZkEvmTestnet as tc, creditCoin3Devnet as td, bitkubTestnet as tf, rei as ti, glideL1Protocol as tl, taikoKatla as tn, meter as to, ancient8Sepolia as tp, skaleHumanProtocol as tr, l3xTestnet as ts, westendAssetHub as tt, eon as tu, zksyncLocalCustomHyperchain as u, omni as ua, humanodeTestnet5 as uc, confluxESpaceTestnet as ud, berachain as uf, radius as ui, fusion as ul, swissdlt as un, meld as uo, adi as up, sixProtocol as ur, kiiTestnetOro as us, viction as ut, elastos as uu, zircuit as v, nibiru as va, hpb as vc, citrea as vd, baseSepoliaPreconf as vf, pulsechainV4 as vi, forta as vl, superseed as vn, marooTestnet as vo, zeroGTestnet as vp, shibariumTestnet as vr, kakarotStarknetSepolia as vs, unreal as vt, edexa as vu, zeroNetwork as w, neonMainnet as wa, hemi as wc, celoAlfajores as wd, b3Sepolia as wf, polynomial as wi, fluent as wl, storyOdyssey as wn, mantle as wo, sepolia as wr, juneoSocotraTestnet as ws, ultronTestnet as wt, dosChainTestnet as wu, zhejiang as x, newton as xa, holesky as xc, chiliz as xd, base as xf, potosTestnet as xi, form as xl, subtensorEvm as xn, mantraDuKongEVMTestnet as xo, zeroG as xp, shardeum as xr, kaia as xs, unique as xt, dustboyIoT as xu, zilliqaTestnet as y, nexilix as ya, horizenTestnet as yc, citrate as yd, baseGoerli as yf, pulsechain as yi, formTestnet as yl, superposition as yn, mapProtocol as yo, zeroGMainnet as yp, shibarium as yr, kakarotSepolia as ys, uniqueQuartz as yt, eden as yu, xoneMainnet as z, monadTestnet as za, ham as zc, bounceBitTestnet as zd, arthera as zf, plasmaTestnet as zi, fantomSonicTestnet as zl, songbirdTestnet as zn, loop as zo, saakuru as zr, jbcTestnet as zs, theta as zt, dbkchain as zu };
