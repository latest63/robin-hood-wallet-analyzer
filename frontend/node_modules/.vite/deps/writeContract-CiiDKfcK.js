import { r as __exportAll } from "./rolldown-runtime-V4kyJ4NV.js";
import { $ as stringify, $t as InvalidAbiItemError, A as padRight, B as from$6, C as from$7, Ct as ContractFunctionZeroDataError, D as fromString$1, Dt as InvalidSerializableTransactionError, E as fromNumber, F as toNumber$1, G as size$1, H as fromString, J as toBoolean, Jt as parseStructs, K as slice$1, Kt as decodeFunctionResult, L as trimLeft$1, Lt as prettyPrint, M as size, Mt as TransactionExecutionError, N as slice, Nt as TransactionNotFoundError, Q as validate$5, Qt as InvalidAbiParametersError, R as validate$4, Rt as formatEther, S as concat, St as ContractFunctionRevertedError, T as fromBytes$2, Tt as FeePayerNonceMismatchError, Ut as ChainMismatchError, V as fromHex$2, Vt as parseAccount, Wt as ChainNotFoundError, X as toString, Xt as parseSignature, Y as toNumber, Yt as parseAbiParameter, Z as trimLeft, Zt as splitParameters, _ as multicall3Bytecode, _t as numberToBytesLE$1, a as serializeStateOverride, at as bitMask$1, bt as CallExecutionError, c as defineFormatter, ct as bytesToNumberLE$1, d as getNodeError, dt as ensureBytes$1, en as isStructSignature, et as BaseError, f as formatBlockParameter, ft as hexToBytes$1, g as erc6492SignatureValidatorByteCode, gt as numberToBytesBE$1, ht as memoized$1, in as PositionOutOfBoundsError$1, it as bitLen$1, k as padLeft, l as extract$1, ln as erc6492SignatureValidatorAbi, lt as concatBytes$2, m as encodeDeployData, mt as isBytes$2, n as assertRequest, nn as decodeAbiParameters, nt as aInRange$1, ot as bytesToHex$1, p as isAddressEqual, pt as inRange$1, q as toBigInt, rn as createCursor, rt as abool$1, s as formatTransactionRequest, sn as erc1271Abi, st as bytesToNumberBE$1, t as call, tn as modifiers, un as multicall3Abi, ut as createHmacDrbg$1, vt as numberToHexUnpadded$1, w as fromBoolean, wt as RawContractError, xt as ContractFunctionExecutionError, y as IntegerOutOfRangeError, yt as validateObject$1 } from "./call-C6GuDgqH.js";
import { F as AbiEventSignatureEmptyTopicsError, H as DecodeLogTopicsMismatch, I as AbiEventSignatureNotFoundError, K as formatAbiItem, O as AbiDecodingDataSizeTooSmallError, S as getAddress, V as DecodeLogDataMismatch, _ as concatHex, a as formatAbiItem$1, g as concat$1, i as toEventSelector, k as AbiDecodingZeroDataError, o as formatAbiParameters, t as encodeFunctionData, w as keccak256$1, x as checksumAddress } from "./encodeFunctionData-35L66rl1.js";
import { A as isHex, O as BaseError$1, a as toBytes$2, c as numberToHex, h as hexToNumber$1, k as size$2, m as hexToBool, n as LruMap$1, p as hexToBigInt, r as hexToBytes$2, s as bytesToHex$2, u as toHex$2 } from "./stringify-BgI-TJVg.js";
import { a as anumber$1, c as concatBytes$3, d as randomBytes$1, f as rotr$1, i as ahash$1, l as createHasher$1, m as toBytes$3, n as abytes$2, o as aoutput$1, r as aexists$1, s as clean$1, t as Hash$1, u as createView$1 } from "./utils-CLmzsG4i.js";
import { T as formatGwei, _ as RpcRequestError, m as UnknownNodeError } from "./createBatchScheduler-D-fKlVQ-.js";
...
async function recoverPublicKey({ hash, signature }) {
	const hashHex = isHex(hash) ? hash : toHex$2(hash);
	...
	return `0x${(() => {
		...
		const signatureHex = isHex(signature) ? signature : toHex$2(signature);
		if (size$2(signatureHex) !== 65) throw new Error("invalid signature length");
		const recoveryBit = toRecoveryBit(hexToNumber$1(`0x${signatureHex.slice(130)}`));
...
function hashAuthorization(parameters) {
	...
	if (to === "bytes") return hexToBytes$2(hash);
	return hash;
}
//#endregion
...
function blobsToCommitments(parameters) {
	...
	const blobs = typeof parameters.blobs[0] === "string" ? parameters.blobs.map((x) => hexToBytes$2(x)) : parameters.blobs;
	const commitments = [];
...
function blobsToProofs(parameters) {
	...
	const to = parameters.to ?? (typeof parameters.blobs[0] === "string" ? "hex" : "bytes");
	const blobs = typeof parameters.blobs[0] === "string" ? parameters.blobs.map((x) => hexToBytes$2(x)) : parameters.blobs;
	const commitments = typeof parameters.commitments[0] === "string" ? parameters.commitments.map((x) => hexToBytes$2(x)) : parameters.commitments;
	const proofs = [];
...
*/
var sha256$5 = /* @__PURE__ */ createHasher$1(() => new SHA256$1());
//#endregion
...
for (let round = 0, R = _1n$9, x = 1, y = 0; round < 24; round++) {
	...
	let t = _0n$9;
	for (let j = 0; j < 7; j++) {
		R = (R << _1n$9 ^ (R >> _7n) * _0x71n) % _256n;
		if (R & _2n$4) t ^= _1n$9 << (_1n$9 << /* @__PURE__ */ BigInt(j)) - _1n$9;
	}
	_SHA3_IOTA.push(t);
}
...
function validate$3(value) {
	return value.length === 66 && validate$4(value, { strict: true });
}
//#endregion
...
function from$5(value) {
	const publicKey = (() => {
		if (validate$4(value)) return fromHex$1(value);
...
function fromPublicKey(publicKey, options = {}) {
	return from$4(`0x${keccak256(`0x${toHex$1(publicKey).slice(4)}`).substring(26)}`, options);
}
/**
...
function FpLegendre$1(Fp, n) {
	const p1mod2 = (Fp.ORDER - _1n$8) / _2n$3;
...
function numToSizedHex$1(num, size) {
	...
	class Point {
		...
		*/
		multiplyUnsafe(sc) {
			...
			aInRange$1("scalar", sc, _0n$6, N);
			const I = Point.ZERO;
			if (sc === _0n$6) return I;
		...
		*/
		multiplyAndAddUnsafe(Q, a, b) {
			const G = Point.BASE;
			const mul = (P, a) => a === _0n$6 || a === _1n$6 || !P.equals(G) ? P.multiplyUnsafe(a) : P.multiply(a);
...
function weierstrass$1(curveDef) {
	...
	class Signature {
		...
		*/
		...
		recoverPublicKey(msgHash) {
			...
			const R = Point.fromHex(prefix + numToSizedHex$1(radj, Fp.BYTES));
			const ir = invN(radj);
			const u1 = modN(-h * ir);
			const u2 = modN(s * ir);
		...
		toCompactHex() {
			const l = nByteLength;
			return numToSizedHex$1(this.r, l) + numToSizedHex$1(this.s, l);
		}
	}
	const utils = {
	...
	*/
	function int2octets(num) {
		aInRange$1("num < 2^" + nBitLength, num, _0n$6, ORDER_MASK);
...
var _1n$5 = BigInt(1);
var _2n$2 = BigInt(2);
var divNearest$1 = (a, b) => (a + b / _2n$2) / b;
/**
...
function sqrtMod$1(y) {
	...
	const b2 = y * y * y % P;
	const b3 = b2 * b2 * y % P;
	const b11 = pow2$1(pow2$1(pow2$1(b3, _3n, P) * b3 % P, _3n, P) * b3 % P, _2n$2, P) * b2 % P;
	const b22 = pow2$1(b11, _11n, P) * b11 % P;
	const b44 = pow2$1(b22, _22n, P) * b22 % P;
	const b88 = pow2$1(b44, _44n, P) * b44 % P;
	const root = pow2$1(pow2$1(pow2$1(pow2$1(pow2$1(pow2$1(b88, _88n, P) * b88 % P, _44n, P) * b44 % P, _3n, P) * b3 % P, _23n, P) * b22 % P, _6n, P) * b2 % P, _2n$2, P);
	if (!Fpk1$1.eql(Fpk1$1.sqr(root), y)) throw new Error("Cannot find square root");
	return root;
}
var Fpk1$1 = Field$1(secp256k1P$1, void 0, void 0, { sqrt: sqrtMod$1 });
/**
...
//#endregion
export { defineTransactionReceipt as $, UnknownRpcError as $t, encode as A, readContract as At, fromHex$1 as B, InvalidRequestRpcError as Bt, toRpc$1 as C, defineBlock as Ct, createCurve$1 as D, BlockNotFoundError as Dt, secp256k1$1 as E, formatTransaction as Et, from$4 as F, ChainDisconnectedError as Ft, validate$3 as G, ParseRpcError as Gt, toHex$1 as H, LimitExceededRpcError as Ht, fromPublicKey as I, DuplicateIdError as It, sha512 as J, ResourceUnavailableRpcError as Jt, sha256$2 as K, ProviderDisconnectedError as Kt, isEqual as L, InternalRpcError as Lt, create as M, AtomicReadyWalletRejectedUpgradeError as Mt, assert$3 as N, AtomicityNotSupportedError as Nt, Field$1 as O, recoverAuthorizationAddress as Ot, checksum as P, BundleTooLargeError as Pt, getCode as Q, UnknownBundleIdError as Qt, validate$2 as R, InvalidInputRpcError as Rt, toHex as S, getBlock as St, yParityToV as T, defineTransaction as Tt, keccak256 as U, MethodNotFoundRpcError as Ut, toBytes as V, JsonRpcVersionUnsupportedError as Vt, sha256 as W, MethodNotSupportedRpcError as Wt, parseEventLogs as X, TransactionRejectedRpcError as Xt, assertCurrentChain as Y, SwitchChainError as Yt, decodeEventLog as Z, UnauthorizedProviderError as Zt, extract as _, blobsToCommitments as _t, AccountTypeNotSupportedError as a, getAction as an, prepareTransactionRequest as at, fromRpc$1 as b, estimateMaxPriorityFeePerGas as bt, NotFoundError as c, getTransactionError as ct, getSelector as d, EmptyBlobError as dt, UnsupportedChainIdError as en, formatTransactionReceipt as et, getSignatureHash as f, InvalidVersionedHashSizeError as ft, assert$2 as g, blobsToProofs as gt, toRpcList as h, sha256$3 as ht, AccountNotFoundError as i, WalletConnectSessionSettlementError as in, defaultParameters as it, format as j, getContractError as jt, decode as k, toRlp as kt, from as l, getTransactionType as lt, fromRpcList as m, commitmentsToVersionedHashes as mt, sendTransaction as n, UnsupportedProviderMethodError as nn, formatLog as nt, verifyHash as o, fillTransaction as ot, getTransaction as p, InvalidVersionedHashVersionError as pt, sha384 as q, ResourceNotFoundRpcError as qt, sendRawTransaction as r, UserRejectedRequestError as rn, estimateGas as rt, secp256k1 as s, getChainId as st, writeContract as t, UnsupportedNonOptionalCapabilityError as tn, receiptStatuses as tt, fromAbi as u, toBlobSidecars as ut, from$2 as v, getTransactionCount as vt, toTuple as w, formatBlock as wt, fromTuple as x, getGasPrice as xt, fromHex as y, estimateFeesPerGas as yt, from$5 as z, InvalidParamsRpcError as zt };
