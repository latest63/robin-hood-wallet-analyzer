...
import { Ft as TransactionReceiptRevertedError, Ht as getChainContractAddress, It as WaitForTransactionReceiptTimeoutError, Kt as decodeFunctionResult, Nt as TransactionNotFoundError, Pt as TransactionReceiptNotFoundError, S as concat, St as ContractFunctionRevertedError, Vt as parseAccount, _ as multicall3Bytecode, a as serializeStateOverride, an as addressResolverAbi, bt as CallExecutionError, cn as erc20Abi, d as getNodeError, dn as textResolverAbi, f as formatBlockParameter, fn as universalResolverResolveAbi, h as deploylessCallViaBytecodeBytecode, l as extract, m as encodeDeployData, n as assertRequest, p as isAddressEqual, pn as universalResolverReverseAbi, s as formatTransactionRequest, t as call$1, u as getCallError, un as multicall3Abi, v as toRpc, wt as RawContractError, xt as ContractFunctionExecutionError } from "./call-C6GuDgqH.js";
import { B as BytesSizeMismatchError, C as isAddress, H as DecodeLogTopicsMismatch, K as formatAbiItem, P as AbiEventNotFoundError, S as getAddress, T as InvalidAddressError, V as DecodeLogDataMismatch, b as sliceHex, d as encodeAbiParameters, g as concat$1, h as integerRegex, i as toEventSelector, k as AbiDecodingZeroDataError, m as bytesRegex, n as getAbiItem, t as encodeFunctionData, v as slice, w as keccak256, x as checksumAddress } from "./encodeFunctionData-35L66rl1.js";
import { A as isHex, O as BaseError$3, _ as trim, a as toBytes, c as numberToHex, f as fromHex, g as hexToString, h as hexToNumber, i as stringToBytes, k as size$1, l as stringToHex, n as LruMap, p as hexToBigInt, s as bytesToHex, t as stringify, u as toHex, w as pad } from "./stringify-BgI-TJVg.js";
import { A as encode$1, At as readContract$1, Dt as BlockNotFoundError, Ft as ChainDisconnectedError, Jt as ResourceUnavailableRpcError, Kt as ProviderDisconnectedError, Nt as AtomicityNotSupportedError, Ot as recoverAuthorizationAddress, Q as getCode, Rt as InvalidInputRpcError, St as getBlock$1, X as parseEventLogs, Xt as TransactionRejectedRpcError, Y as assertCurrentChain, Yt as SwitchChainError, Z as decodeEventLog, a as AccountTypeNotSupportedError, an as getAction$1, at as prepareTransactionRequest$1, bt as estimateMaxPriorityFeePerGas$1, c as NotFoundError, ct as getTransactionError, d as getSelector$2, et as formatTransactionReceipt, f as getSignatureHash, i as AccountNotFoundError, in as WalletConnectSessionSettlementError, it as defaultParameters, jt as getContractError, k as decode, l as from$3, n as sendTransaction$1, nt as formatLog, o as verifyHash, ot as fillTransaction, p as getTransaction$1, r as sendRawTransaction, rn as UserRejectedRequestError, rt as estimateGas$1, st as getChainId$1, t as writeContract$1, tn as UnsupportedNonOptionalCapabilityError, tt as receiptStatuses, u as fromAbi$2, vt as getTransactionCount$1, wt as formatBlock, xt as getGasPrice$1, yt as estimateFeesPerGas$1 } from "./writeContract-CiiDKfcK.js";
import { i as from$4, t as format$2 } from "./Value-DteXBHbV.js";
import { _ as RpcRequestError, b as WebSocketRequestError, m as UnknownNodeError, n as withResolvers, r as ExecutionRevertedError, t as createBatchScheduler, v as SocketClosedError, y as TimeoutError } from "./createBatchScheduler-D-fKlVQ-.js";
import "./localBatchGatewayRequest-CvhG4MQ7.js";
import { a as getHttpRpcClient, c as withRetry, i as uid$1, l as wait, n as UrlRequiredError, o as idCache, r as createTransport, s as withTimeout } from "./http-DAIgS2h2.js";
import { C as useQueryClient, m as useQuery$1, nt as replaceEqualDeep, r as useMutation, t as useInfiniteQuery$1 } from "./modern-zN6nBF3T.js";
...
*/
async function getEnsAddress$1(client, parameters) {
...
* // 'wevm_dev'
*/
async function getEnsText$1(client, parameters) {
...
async function getEnsAvatar$1(client, { blockNumber, blockTag, assetGatewayUrls, name, gatewayUrls, strict, universalResolverAddress }) {
	const record = await getAction$1(client, getEnsText$1, "getEnsText")({
		blockNumber,
		blockTag,
		key: "avatar",
		name,
...
*/
async function getEnsResolver$1(client, parameters) {
	...
	const [resolverAddress] = await getAction$1(client, readContract$1, "readContract")({
		address: universalResolverAddress,
		abi: [{
			inputs: [{ type: "bytes" }],
			name: "findResolver",
...
async function createAccessList(client, args) {
	...
	try {
		...
		if (response.error) throw new BaseError$3(response.error, { details: response.error });
		return {
...
var FilterTypeNotSupportedError$1 = class extends BaseError$3 {
	constructor(type) {
...
function encodeEventTopics(parameters) {
	...
	if (abiItem.type !== "event") throw new AbiEventNotFoundError(void 0, { docsPath });
	let topics = [];
...
function encodeArg({ param, value }) {
	...
	if (param.type === "tuple" || param.type.match(/^(.*)\[(\d+)?\]$/)) throw new FilterTypeNotSupportedError$1(param.type);
...
async function estimateContractGas(client, parameters) {
	...
	try {
		return await getAction$1(client, estimateGas$1, "estimateGas")({
...
*/
async function getBalance$2(client, { address, blockHash, blockNumber, blockTag = client.experimental_blockTag ?? "latest", requireCanonical }) {
...
* // 69420n
*/
async function getBlockNumber$1(client, { cacheTime = client.cacheTime } = {}) {
...
*/
async function getBlockTransactionCount$1(client, { blockHash, blockNumber, blockTag = "latest" } = {}) {
	const blockNumberHex = blockNumber !== void 0 ? numberToHex(blockNumber) : void 0;
	let count;
...
async function getEip712Domain(client, parameters) {
	...
	try {
		const [fields, name, version, chainId, verifyingContract, salt, extensions] = await getAction$1(client, readContract$1, "readContract")({
			abi,
			address,
...
* })
*/
async function getFeeHistory$1(client, { blockCount, blockNumber, blockTag = "latest", rewardPercentiles }) {
...
async function getWebSocketRpcClient(url, options = {}) {
	...
	return getSocketRpcClient({
		async getSocket({ onClose, onError, onOpen, onResponse }) {
			const WebSocket = await import("./native-CZsxlSfx.js").then((n) => (n.t(), n.n)).then((module) => module.WebSocket);
...
var InvalidTypedDataTypeError = class extends BaseError$3 {
	constructor({ type }) {
...
function formatUnits(value, decimals) {
	return format$2(value, decimals);
}
//#endregion
...
* })
*/
async function getProof$1(client, { address, blockHash, blockNumber, blockTag = "latest", requireCanonical, storageKeys }) {
	const block = formatBlockParameter({
		blockHash,
		blockNumber,
		blockTag,
...
* })
*/
async function getStorageAt$1(client, { address, blockHash, blockNumber, blockTag = "latest", requireCanonical, slot }) {
	const block = formatBlockParameter({
		blockHash,
		blockNumber,
		blockTag,
...
* })
*/
async function getTransactionConfirmations$1(client, { hash, transactionReceipt }) {
	const [blockNumber, transaction] = await Promise.all([getAction$1(client, getBlockNumber$1, "getBlockNumber")({}), hash ? getAction$1(client, getTransaction$1, "getTransaction")({ hash }) : void 0]);
...
* })
*/
async function getTransactionReceipt$1(client, { hash }) {
...
async function multicall$1(client, parameters) {
	...
	const aggregate3Results = await Promise.allSettled(batches.map((calls) => {
		...
		return getAction$1(client, readContract$1, "readContract")({
...
async function scheduleMulticall(client, parameters) {
	...
	const { schedule } = createBatchScheduler({
		...
		fn: (calls) => getAction$1(client, readContract$1, "readContract")({
			...multicallAddress === null ? { code: multicall3Bytecode } : { address: multicallAddress },
			...rest,
			abi: multicall3Abi,
			args: [calls],
...
var transferEventSelector = getSelector$1(from$1("event Transfer(address indexed from, address indexed to, uint256 value)"));
var balanceOfFunction = from("function balanceOf(address) returns (uint256)");
var decimalsFunction = from("function decimals() returns (uint256)");
var tokenUriFunction = from("function tokenURI(uint256) returns (string)");
var symbolFunction = from("function symbol() returns (string)");
var staticCallFunction = from("function query(address target, bytes data)");
/**
...
async function simulateCalls(client, parameters) {
	...
	if (traceAssetChanges && typeof baseBlockNumber !== "bigint" && blockTag_ !== "earliest" && blockTag_ !== "pending") {
		if (blockTag_ === "latest") baseBlockNumber = await getBlockNumber$1(client, { cacheTime: 0 });
		else {
			const block = await getBlock$1(client, { blockTag: blockTag_ });
			if (typeof block.number !== "bigint") throw new BaseError$3(`Block tag \`${blockTag_}\` did not resolve to a number.`);
...
* })
*/
async function simulateContract$1(client, parameters) {
...
async function verifyMessage$1(client, { address, message, factory, factoryData, signature, ...callRequest }) {
	...
	return getAction$1(client, verifyHash, "verifyHash")({
		address,
		factory,
		factoryData,
		hash,
...
* })
*/
function watchBlockNumber$1(client, { emitOnBegin = false, emitMissed = false, onBlockNumber, onError, poll: poll_, pollingInterval = client.pollingInterval }) {
	const enablePolling = (() => {
	...
	const pollBlockNumber = () => {
		return observe(stringify([
			...
			try {
				const blockNumber = await getAction$1(client, getBlockNumber$1, "getBlockNumber")({ cacheTime: 0 });
...
* })
*/
async function waitForTransactionReceipt$1(client, parameters) {
	...
	_unobserve = observe(observerId, {
		...
		receipt = await getAction$1(client, getTransactionReceipt$1, "getTransactionReceipt")({ hash }).catch(() => void 0);
		...
		_unwatch = getAction$1(client, watchBlockNumber$1, "watchBlockNumber")({
			emitMissed: true,
			emitOnBegin: true,
			poll: true,
			pollingInterval,
				...
				try {
					...
					if (checkReplacement && !transaction) {
						...
						await withRetry(async () => {
							transaction = await getAction$1(client, getTransaction$1, "getTransaction")({ hash });
					...
					receipt = await getAction$1(client, getTransactionReceipt$1, "getTransactionReceipt")({ hash });
					if (confirmations > 1 && (!receipt.blockNumber || blockNumber - receipt.blockNumber + 1n < confirmations)) return;
					done(() => emit.resolve(receipt));
				} catch (err) {
					if (err instanceof TransactionNotFoundError || err instanceof TransactionReceiptNotFoundError) {
						...
						try {
							...
							retrying = true;
							const block = await withRetry(() => getAction$1(client, getBlock$1, "getBlock")({
								blockNumber,
							...
							receipt = await getAction$1(client, getTransactionReceipt$1, "getTransactionReceipt")({ hash: replacementTransaction.hash });
							if (confirmations > 1 && (!receipt.blockNumber || blockNumber - receipt.blockNumber + 1n < confirmations)) return;
							let reason = "replaced";
...
* })
*/
function watchBlocks$1(client, { blockTag = client.experimental_blockTag ?? "latest", emitMissed = false, emitOnBegin = false, onBlock, onError, includeTransactions: includeTransactions_, poll: poll_, pollingInterval = client.pollingInterval }) {
	const enablePolling = (() => {
		if (typeof poll_ !== "undefined") return poll_;
		if (client.transport.type === "webSocket" || client.transport.type === "ipc") return false;
		if (client.transport.type === "fallback" && (client.transport.transports[0].config.type === "webSocket" || client.transport.transports[0].config.type === "ipc")) return false;
	...
	const pollBlocks = () => {
		return observe(stringify([
			...
			try {
				const block = await getAction$1(client, getBlock$1, "getBlock")({
					blockTag,
					includeTransactions
				});
	...
	const subscribeBlocks = () => {
		...
		(async () => {
			try {
				if (emitOnBegin) getAction$1(client, getBlock$1, "getBlock")({
					blockTag,
					includeTransactions
				}).then((block) => {
					if (!active) return;
...
* })
*/
function watchContractEvent$1(client, parameters) {
			...
			const unwatch = poll(async () => {
				...
				try {
					...
					if (filter) logs = await getAction$1(client, getFilterChanges, "getFilterChanges")({ filter });
						...
						const blockNumber = await getAction$1(client, getBlockNumber$1, "getBlockNumber")({});
...
* })
*/
function watchPendingTransactions$1(client, { batch = true, onError, onTransactions, poll: poll_, pollingInterval = client.pollingInterval }) {
...
async function resolveTokenWithDecimals(client, parameters) {
	...
	return {
		address,
		decimals: await readContract$1(client, {
			abi: erc20Abi,
			address,
...
async function approve(client, parameters) {
	return approve.inner(writeContract$1, client, parameters);
}
(function(approve) {
	/** @internal */
	...
	*/
	async function simulate(client, parameters) {
		return simulateContract$1(client, {
			...pickWriteParameters(parameters),
			...approve.call(client, parameters)
		});
	}
...
async function getAllowance(client, parameters) {
	...
	const [amount, { decimals: resolved }] = await Promise.all([readContract$1(client, {
		...rest,
...
async function getMetadata(client, parameters) {
	...
	const [decimals_, name, symbol] = await Promise.all([
		declared?.decimals ?? readContract$1(client, {
			...rest,
			abi: erc20Abi,
			address,
			functionName: "decimals"
		}),
		declared?.name ?? readContract$1(client, {
			...rest,
			abi: erc20Abi,
			address,
			functionName: "name"
		}),
		declared?.symbol ?? readContract$1(client, {
			...rest,
			abi: erc20Abi,
			address,
			functionName: "symbol"
...
async function transfer(client, parameters) {
	return transfer.inner(writeContract$1, client, parameters);
}
(function(transfer) {
	/** @internal */
	async function inner(action, client, parameters) {
...
* })
*/
async function sendCalls$1(client, parameters) {
	...
	try {
		...
		if (experimental_fallback && (error.name === "MethodNotFoundRpcError" || error.name === "MethodNotSupportedRpcError" || error.name === "UnknownRpcError" || error.details.toLowerCase().includes("does not exist / is not available") || error.details.toLowerCase().includes("missing or invalid. request()") || error.details.toLowerCase().includes("did not match any variant of untagged enum") || error.details.toLowerCase().includes("account upgraded to unsupported contract") || error.details.toLowerCase().includes("eip-7702 not supported") || error.details.toLowerCase().includes("unsupported wc_ method") || error.details.toLowerCase().includes("feature toggled misconfigured") || error.details.toLowerCase().includes("jsonrpcengine: response has no error or result for request"))) {
			...
			for (const call of calls) {
				try {
					const value = await sendTransaction$1(client, {
						account,
						chain,
						data: call.data,
						to: call.to,
...
*/
async function getCallsStatus$1(client, parameters) {
...
async function prepareAuthorization(client, parameters) {
	...
	if (typeof authorization.chainId === "undefined") authorization.chainId = client.chain?.id ?? await getAction$1(client, getChainId$1, "getChainId")({});
	if (typeof authorization.nonce === "undefined") {
		authorization.nonce = await getAction$1(client, getTransactionCount$1, "getTransactionCount")({
...
var BundleFailedError = class extends BaseError$3 {
	constructor(result) {
...
*/
async function waitForCallsStatus$1(client, parameters) {
		...
		const unpoll = poll(async () => {
			...
			try {
				const result = await withRetry(async () => {
					const result = await getAction$1(client, getCallsStatus$1, "getCallsStatus")({ id });
...
var WaitForCallsStatusTimeoutError = class extends BaseError$3 {
	constructor({ id }) {
...
var getVersion$1 = () => `@wagmi/core@${version$1}`;
//#endregion
...
var BaseError$1 = class BaseError$1 extends Error {
	...
	constructor(shortMessage, options = {}) {
		...
		const details = options.cause instanceof BaseError$1 ? options.cause.details : options.cause?.message ? options.cause.message : options.details;
		const docsPath = options.cause instanceof BaseError$1 ? options.cause.docsPath || options.docsPath : options.docsPath;
		this.message = [
...
var ChainNotConfiguredError = class extends BaseError$1 {
	constructor() {
...
var ConnectorAlreadyConnectedError = class extends BaseError$1 {
	constructor() {
...
var ConnectorNotConnectedError = class extends BaseError$1 {
	constructor() {
...
var ConnectorNotFoundError = class extends BaseError$1 {
	constructor() {
...
var ConnectorAccountNotFoundError = class extends BaseError$1 {
...
var ConnectorChainMismatchError = class extends BaseError$1 {
...
var ConnectorUnavailableReconnectingError = class extends BaseError$1 {
	...
	function extend(base) {
		return (extendFn) => {
			...
			for (const key in extended) {
				...
				if (isPlainObject$2(a) && isPlainObject$2(b)) combined[key] = {
					...a,
					...b
				};
			}
...
function publicActions(client) {
	return {
		...
		estimateGas: (args) => estimateGas$1(client, args),
		getBalance: (args) => getBalance$2(client, args),
		getBlobBaseFee: () => getBlobBaseFee(client),
		getBlock: (args) => getBlock$1(client, args),
		getBlockNumber: (args) => getBlockNumber$1(client, args),
		getBlockReceipts: (args) => getBlockReceipts(client, args),
		getBlockTransactionCount: (args) => getBlockTransactionCount$1(client, args),
		...
		getEnsAddress: (args) => getEnsAddress$1(client, args),
		getEnsAvatar: (args) => getEnsAvatar$1(client, args),
		getEnsName: (args) => getEnsName$1(client, args),
		getEnsResolver: (args) => getEnsResolver$1(client, args),
		getEnsText: (args) => getEnsText$1(client, args),
		getFeeHistory: (args) => getFeeHistory$1(client, args),
		estimateFeesPerGas: (args) => estimateFeesPerGas$1(client, args),
		getFilterChanges: (args) => getFilterChanges(client, args),
		getFilterLogs: (args) => getFilterLogs(client, args),
		getGasPrice: () => getGasPrice$1(client),
		getLogs: (args) => getLogs(client, args),
		getProof: (args) => getProof$1(client, args),
		estimateMaxPriorityFeePerGas: (args) => estimateMaxPriorityFeePerGas$1(client, args),
		fillTransaction: (args) => fillTransaction(client, args),
		getRawTransaction: (args) => getRawTransaction(client, args),
		getStorageAt: (args) => getStorageAt$1(client, args),
		getTransaction: (args) => getTransaction$1(client, args),
		getTransactionConfirmations: (args) => getTransactionConfirmations$1(client, args),
		getTransactionCount: (args) => getTransactionCount$1(client, args),
		getTransactionReceipt: (args) => getTransactionReceipt$1(client, args),
		multicall: (args) => multicall$1(client, args),
		prepareTransactionRequest: (args) => prepareTransactionRequest$1(client, args),
		readContract: (args) => readContract$1(client, args),
		sendRawTransaction: (args) => sendRawTransaction(client, args),
		sendRawTransactionSync: (args) => sendRawTransactionSync(client, args),
		simulate: (args) => simulateBlocks(client, args),
		simulateBlocks: (args) => simulateBlocks(client, args),
		simulateCalls: (args) => simulateCalls(client, args),
		simulateContract: (args) => simulateContract$1(client, args),
		...
		waitForTransactionReceipt: (args) => waitForTransactionReceipt$1(client, args),
		watchBlockHeaders: (args) => watchBlockHeaders(client, args),
		watchBlocks: (args) => watchBlocks$1(client, args),
		watchBlockNumber: (args) => watchBlockNumber$1(client, args),
		watchContractEvent: (args) => watchContractEvent$1(client, args),
		watchEvent: (args) => watchEvent(client, args),
		watchPendingTransactions: (args) => watchPendingTransactions$1(client, args),
...
function bindPublicToken(client) {
	return {
		...
		getBalance: bindActionDecorators(client, getBalance$1),
...
function fallback$1(transports_, config = {}) {
...
async function getBalance(config, parameters) {
	...
	const client = config.getClient({ chainId });
	const value = await getAction(client, getBalance$2, "getBalance")(blockNumber ? {
		address,
		blockNumber
	} : {
		address,
...
var ProviderNotFoundError = class extends BaseError$1 {
	constructor() {
...
var SwitchChainNotSupportedError = class extends BaseError$1 {
	constructor({ connector }) {
...
function createConfig(parameters) {
	...
	if ("2.22.1".startsWith(prefix)) currentVersion = Number.parseInt(version$1.replace(prefix, ""), 10);
...
//#endregion
export { useCall as $, hashMessage as $t, useProof as A, injected as At, useEnsName as B, ChainNotConfiguredError as Bt, useSendTransaction as C, createConfig as Ct, useReadContracts as D, deserialize as Dt, useReconnect as E, serialize as Et, useEstimateMaxPriorityFeePerGas as F, webSocket as Ft, useConnectorClient as G, ConnectorUnavailableReconnectingError as Gt, useEnsAddress as H, ConnectorAlreadyConnectedError as Ht, useEstimateGas as I, fallback$1 as It, useConnectors as J, waitForTransactionReceipt$1 as Jt, useConnections as K, waitForCallsStatus$1 as Kt, useEstimateFeesPerGas as L, custom as Lt, useInfiniteReadContracts as M, ProviderNotFoundError as Mt, useGasPrice as N, SwitchChainNotSupportedError as Nt, useReadContract as O, import_eventemitter3 as Ot, useFeeHistory as P, deepEqual as Pt, useCallsStatus as Q, hashTypedData as Qt, useEnsText as R, publicActions as Rt, useSendTransactionSync as S, unstable_connector as St, useSendCalls as T, noopStorage as Tt, useDisconnect as U, ConnectorChainMismatchError as Ut, useEnsAvatar as V, ConnectorAccountNotFoundError as Vt, useDeployContract as W, ConnectorNotFoundError as Wt, useChains as X, observe as Xt, useClient as Y, poll as Yt, useCapabilities as Z, formatUnits as Zt, useStorageAt as _, normalizeChainId as _t, useWalletClient as a, useWatchBlocks as at, useSignMessage as b, parseCookie as bt, useVerifyTypedData as c, useAccountEffect as ct, useTransactionCount as d, WagmiProviderNotFoundError as dt, useBytecode as et, useTransactionConfirmations as f, BaseError as ft, useSwitchAccount as g, Hydrate as gt, useSwitchChain as h, WagmiProvider as ht, useWatchAsset as i, useBlock as it, usePrepareTransactionRequest as j, createConnector as jt, usePublicClient as k, mock as kt, useVerifyMessage as l, useAccount as lt, useToken as m, WagmiContext as mt, useWatchPendingTransactions as n, useBlockNumber as nt, useWaitForTransactionReceipt as o, useBalance as ot, useTransaction as p, version as pt, useConnect as q, prepareAuthorization as qt, useWatchContractEvent as r, useWatchBlockNumber as rt, useWaitForCallsStatus as s, useChainId as st, useWriteContract as t, useBlockTransactionCount as tt, useTransactionReceipt as u, useConfig as ut, useSimulateContract as v, cookieStorage as vt, useSendCallsSync as w, createStorage as wt, useShowCallsStatus as x, fallback as xt, useSignTypedData as y, cookieToInitialState as yt, useEnsResolver as z, createClient as zt };
