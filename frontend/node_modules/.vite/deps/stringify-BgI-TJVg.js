...
var RlpDepthLimitExceededError = class extends BaseError {
	constructor({ limit }) {
		super(`RLP depth limit of \`${limit}\` exceeded.`, { name: "RlpDepthLimitExceededError" });
	}
};
var RlpListBoundaryExceededError = class extends BaseError {
...
var RlpTrailingBytesError = class extends BaseError {
	constructor({ count }) {
...
//#endregion
export { isHex as A, RlpTrailingBytesError as C, SliceOffsetOutOfBoundsError as D, InvalidBytesLengthError as E, BaseError as O, RlpListBoundaryExceededError as S, padHex as T, trim as _, toBytes as a, InvalidHexValueError as b, numberToHex as c, assertSize as d, fromHex as f, hexToString as g, hexToNumber as h, stringToBytes as i, size as k, stringToHex as l, hexToBool as m, LruMap as n, boolToHex as o, hexToBigInt as p, hexToBytes as r, bytesToHex as s, stringify as t, toHex as u, IntegerOutOfRangeError as v, pad as w, RlpDepthLimitExceededError as x, InvalidBytesBooleanError as y };
