import { n as __esmMin } from "./rolldown-runtime-V4kyJ4NV.js";
import { Ct as ContractFunctionZeroDataError, Lt as prettyPrint, St as ContractFunctionRevertedError, Vt as parseAccount, a as serializeStateOverride, nn as decodeAbiParameters, p as isAddressEqual, qt as parseAbi, xt as ContractFunctionExecutionError, zt as decodeErrorResult } from "./call-C6GuDgqH.js";
import { A as AbiEncodingLengthMismatchError, B as BytesSizeMismatchError, C as isAddress, G as UnsupportedPackedAbiType, T as InvalidAddressError, _ as concatHex, d as encodeAbiParameters, g as concat$1, h as integerRegex, m as bytesRegex, p as arrayRegex, t as encodeFunctionData, v as slice$2, w as keccak256 } from "./encodeFunctionData-35L66rl1.js";
import { A as isHex, O as BaseError$1, _ as trim, c as numberToHex, g as hexToString, h as hexToNumber$1, i as stringToBytes, k as size$2, l as stringToHex, n as LruMap, o as boolToHex, p as hexToBigInt, r as hexToBytes$1, t as stringify$1, u as toHex$2, w as pad$1 } from "./stringify-BgI-TJVg.js";
import { At as readContract, Q as getCode, an as getAction, et as formatTransactionReceipt, i as AccountNotFoundError, nt as formatLog, s as secp256k1$1, st as getChainId, yt as estimateFeesPerGas } from "./writeContract-CiiDKfcK.js";
import { T as formatGwei } from "./createBatchScheduler-D-fKlVQ-.js";
import { $t as hashMessage, Kt as waitForCallsStatus, Ot as import_eventemitter3, Qt as hashTypedData, Rt as publicActions, Xt as observe, Yt as poll, qt as prepareAuthorization, zt as createClient } from "./exports-BrENAa9C.js";
import { r as decodeFunctionData } from "./localBatchGatewayRequest-CvhG4MQ7.js";
import { Ai as polygon, Df as avalanche, Id as bsc, Sp as defineChain, Xf as arbitrum, _f as baseSepolia, ko as mainnet, r as zora, ra as optimism, ta as optimismSepolia, wr as sepolia, xf as base } from "./chains-DdtDKoex.js";
import { t as http } from "./http-DAIgS2h2.js";
import { i as get$1, n as createStore$1, o as set, r as del } from "./dist-BGzp5k7P.js";
...
function encode(type, value, isArray = false) {
	if (type === "address") {
		...
		return pad$1(address.toLowerCase(), { size: isArray ? 32 : null });
	}
	if (type === "string") return stringToHex(value);
	if (type === "bytes") return value;
	if (type === "bool") return pad$1(boolToHex(value), { size: isArray ? 32 : 1 });
...
function parseSignature(signatureHex) {
	const { r, s } = secp256k1$1.Signature.fromCompact(signatureHex.slice(2, 130));
...
function M(n) {
	(!n.__d && (n.__d = !0) && i$2.push(n) && !P.__r++ || o$1 !== l$1.debounceRendering) && ((o$1 = l$1.debounceRendering) || r$2)(P);
}
function P() {
	var n, u, t, o, r, e, c, s;
	for (i$2.sort(f$2); n = i$2.shift();) n.__d && (u = i$2.length, o = void 0, e = (r = (t = n).__v).__e, c = [], s = [], t.__P && ((o = d$1({}, r)).__v = r.__v + 1, l$1.vnode && l$1.vnode(o), O(t.__P, o, r, t.__n, t.__P.namespaceURI, 32 & r.__u ? [e] : null, c, null == e ? x(r) : e, !!(32 & r.__u), s), o.__v = r.__v, o.__.__k[o.__i] = o, j$1(c, o, s), o.__e != e && C$1(o)), i$2.length > u && i$2.sort(f$2));
	P.__r = 0;
}
...
function $(n, l, u) {
	...
	for (n.__k = [], t = 0; t < e; t++) null != (i = l[t]) && "boolean" != typeof i && "function" != typeof i ? (r = t + a, (i = n.__k[t] = "string" == typeof i || "number" == typeof i || "bigint" == typeof i || i.constructor == String ? g(null, i, null, null, null) : y$1(i) ? g(b, { children: i }, null, null, null) : void 0 === i.constructor && i.__b > 0 ? g(i.type, i.props, i.key, i.ref ? i.ref : null, i.__v) : i).__ = n, i.__b = n.__b + 1, o = null, -1 !== (f = i.__i = L(i, u, r, s)) && (s--, (o = u[f]) && (o.__u |= 131072)), null == o || null === o.__v ? (-1 == f && a--, "function" != typeof i.type && (i.__u |= 65536)) : f !== r && (f == r - 1 ? a-- : f == r + 1 ? a++ : (f > r ? a-- : a++, i.__u |= 65536))) : i = n.__k[t] = null;
...
function O(n, u, t, i, o, r, f, e, c, s) {
	...
	n: if ("function" == typeof T) try {
		if (m = u.props, x = "prototype" in T && T.prototype.render, C = (a = T.contextType) && i[a.__c], M = a ? C ? C.props.value : a.__ : i, t.__c ? g = (h = u.__c = t.__c).__ = h.__E : (x ? u.__c = h = new T(m, M) : (u.__c = h = new k$1(m, M), h.constructor = T, h.render = q), C && C.sub(h), h.props = m, h.state || (h.state = {}), h.context = M, h.__n = i, v = h.__d = !0, h.__h = [], h._sb = []), x && null == h.__s && (h.__s = h.state), x && null != T.getDerivedStateFromProps && (h.__s == h.state && (h.__s = d$1({}, h.__s)), d$1(h.__s, T.getDerivedStateFromProps(m, h.__s))), p = h.props, w = h.state, h.__v = u, v) x && null == T.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(), x && null != h.componentDidMount && h.__h.push(h.componentDidMount);
		else {
		...
		while (h.__d && ++I < 25);
		h.state = h.__s, null != h.getChildContext && (i = d$1(d$1({}, i), h.getChildContext())), x && !v && null != h.getSnapshotBeforeUpdate && (_ = h.getSnapshotBeforeUpdate(p, w)), S(n, y$1(L = null != a && a.type === b && null == a.key ? a.props.children : a) ? L : [L], u, t, i, o, r, f, e, c, s), h.base = u.__e, u.__u &= -161, h.__h.length && f.push(h), g && (h.__E = h.__ = null);
	} catch (n) {
...
function z$1(u, t, i, o, r, f, e, c, s) {
	...
	if (null === C) b === k || c && u.data === k || (u.data = k);
		...
		else if (p && (u.innerHTML = ""), S(u, y$1(d) ? d : [d], t, i, o, "foreignObject" === C ? "http://www.w3.org/1999/xhtml" : r, f, e, f ? f[0] : i.__k && x(i, 0), c, s), null != f) for (a = f.length; a--;) w$1(f[a]);
...
function B$1(u, t, i) {
	var o, r, f, e;
	l$1.__ && l$1.__(u, t), r = (o = "function" == typeof i) ? null : i && i.__k || t.__k, f = [], e = [], O(t, u = (!o && i || t).__k = _(b, null, [u]), r || h$1, h$1, t.namespaceURI, !o && i ? [i] : r ? null : t.firstChild ? n.call(t.childNodes) : null, f, !o && i ? i : r ? r.__e : t.firstChild, o, e), j$1(f, u, e);
}
var n, l$1, u$2, i$2, o$1, r$2, f$2, e$1, c$1, s$1, h$1, v$1, p$1, y$1;
var init_preact_module = __esmMin((() => {
	...
	n = v$1.slice, l$1 = { __e: function(n, l, u, t) {
		...
		throw n;
	} }, u$2 = 0, k$1.prototype.setState = function(n, l) {
	...
	}, k$1.prototype.render = b, i$2 = [], r$2 = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, f$2 = function(n, l) {
...
function u$1(e, t, n, o, i, u) {
	...
	return l$1.vnode && l$1.vnode(p), p;
}
//#endregion
...
var Dialog = class {
	...
	clear() {
		this.items.clear();
		if (this.root) B$1(null, this.root);
	}
	render() {
		if (this.root) B$1(u$1("div", { children: u$1(DialogContainer, { children: Array.from(this.items.entries()).map(([key, itemProps]) => _(DialogInstance, {
			...itemProps,
			key,
			handleClose: () => {
				this.clear();
...
var DialogContainer = (props) => {
	...
	return u$1("div", {
		...
		children: [u$1("style", { children: Dialog_css_default }), u$1("div", {
		...
		children: [
			u$1("div", {
				...
				children: [u$1("div", {
					...
					children: [u$1(BaseLogo, { fill: "blue" }), shouldShowHeaderTitle && u$1("div", {
			...
			actionItems && actionItems.length > 0 && u$1("div", {
				class: "-base-acc-sdk-dialog-instance-actions",
				children: actionItems.map((action, i) => u$1("button", {
...
function toPackedUserOperation(userOperation, options = {}) {
	...
	return {
		accountGasLimits: concat$1([pad$1(numberToHex(verificationGasLimit || 0n), { size: 16 }), pad$1(numberToHex(callGasLimit || 0n), { size: 16 })]),
		callData,
		initCode: getInitCode(userOperation, options),
		gasFees: concat$1([pad$1(numberToHex(maxPriorityFeePerGas || 0n), { size: 16 }), pad$1(numberToHex(maxFeePerGas || 0n), { size: 16 })]),
		nonce: userOperation.nonce ?? 0n,
		paymasterAndData: paymaster ? concat$1([
			paymaster,
			pad$1(numberToHex(paymasterVerificationGasLimit || 0n), { size: 16 }),
			pad$1(numberToHex(paymasterPostOpGasLimit || 0n), { size: 16 }),
			paymasterData || "0x",
...
var AccountNotDeployedError = class extends BaseError$1 {
	constructor({ cause }) {
...
var FailedToSendToBeneficiaryError = class extends BaseError$1 {
	constructor({ cause }) {
...
var GasValuesOverflowError = class extends BaseError$1 {
	constructor({ cause }) {
...
var HandleOpsOutOfGasError = class extends BaseError$1 {
	constructor({ cause }) {
...
var InitCodeFailedError = class extends BaseError$1 {
...
var InitCodeMustCreateSenderError = class extends BaseError$1 {
	constructor({ cause, factory, factoryData, initCode }) {
...
var InitCodeMustReturnSenderError = class extends BaseError$1 {
...
var InsufficientPrefundError = class extends BaseError$1 {
	constructor({ cause }) {
...
var InternalCallOnlyError = class extends BaseError$1 {
	constructor({ cause }) {
...
var InvalidAggregatorError = class extends BaseError$1 {
	constructor({ cause }) {
...
var InvalidAccountNonceError = class extends BaseError$1 {
...
var InvalidBeneficiaryError = class extends BaseError$1 {
	constructor({ cause }) {
...
var InvalidFieldsError = class extends BaseError$1 {
	constructor({ cause }) {
...
var InvalidPaymasterAndDataError = class extends BaseError$1 {
...
var PaymasterDepositTooLowError = class extends BaseError$1 {
	constructor({ cause }) {
...
var PaymasterFunctionRevertedError = class extends BaseError$1 {
	constructor({ cause }) {
...
var PaymasterNotDeployedError = class extends BaseError$1 {
	constructor({ cause }) {
...
var PaymasterRateLimitError = class extends BaseError$1 {
	constructor({ cause }) {
...
var PaymasterStakeTooLowError = class extends BaseError$1 {
	constructor({ cause }) {
...
var PaymasterPostOpFunctionRevertedError = class extends BaseError$1 {
	constructor({ cause }) {
...
var SenderAlreadyConstructedError = class extends BaseError$1 {
	constructor({ cause, factory, factoryData, initCode }) {
...
var SignatureCheckFailedError = class extends BaseError$1 {
	constructor({ cause }) {
...
var SmartAccountFunctionRevertedError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UnsupportedSignatureAggregatorError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UserOperationExpiredError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UserOperationPaymasterExpiredError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UserOperationSignatureError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UserOperationPaymasterSignatureError = class extends BaseError$1 {
	constructor({ cause }) {
		super("Signature provided for the User Operation is invalid.", {
			cause,
...
var UserOperationRejectedByEntryPointError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UserOperationRejectedByPaymasterError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UserOperationRejectedByOpCodeError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UserOperationOutOfTimeRangeError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UnknownBundlerError = class extends BaseError$1 {
	constructor({ cause }) {
...
var VerificationGasLimitExceededError = class extends BaseError$1 {
	constructor({ cause }) {
...
var VerificationGasLimitTooLowError = class extends BaseError$1 {
	constructor({ cause }) {
...
var UserOperationExecutionError = class extends BaseError$1 {
...
var UserOperationReceiptNotFoundError = class extends BaseError$1 {
	constructor({ hash }) {
...
var UserOperationNotFoundError = class extends BaseError$1 {
	constructor({ hash }) {
		super(`User Operation with hash "${hash}" could not be found.`, { name: "UserOperationNotFoundError" });
	}
};
var WaitForUserOperationReceiptTimeoutError = class extends BaseError$1 {
	constructor({ hash }) {
...
function getRevertData(error) {
	...
	error.walk((e) => {
		const error = e;
		if (typeof error.data === "string" || typeof error.data?.revertData === "string" || !(error instanceof BaseError$1) && typeof error.message === "string") {
...
async function prepareUserOperation(client, parameters_) {
	...
	const [callData, factory, fees, nonce, authorization] = await Promise.all([
		...
		(async () => {
			...
			if (account.entryPoint.version === "0.6") return { initCode: factory && factoryData ? concat$1([factory, factoryData]) : void 0 };
			return {
				factory,
				factoryData
			};
	...
	if (typeof callData !== "undefined") request.callData = dataSuffix ? concat$1([callData, dataSuffix]) : callData;
...
var sha256$2 = /* @__PURE__ */ createHasher$1(() => new SHA256$1());
//#endregion
...
/*#__PURE__*/ ({ ...Object.fromEntries(Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((a, i) => [a.charCodeAt(0), i])) }), "=".charCodeAt(0), "-".charCodeAt(0), "_".charCodeAt(0);
/**
...
function addSenderToRequest(request, sender) {
	...
	switch (request.method) {
		...
		case "eth_signTypedData_v4":
			params[0] = sender;
			break;
		case "personal_sign": params[1] = sender;
	}
	return {
		...request,
		params
			...
			switch (args.method) {
				...
				case "eth_sendTransaction": {
					...
					return waitForCallsTransactionHash({
						client,
						id: await request(sendCallsRequest)
					});
				}
				case "wallet_sendCalls": {
					assertArrayPresence(args.params);
...
var Signer = class {
	...
	async _request(request) {
		...
		switch (request.method) {
			...
			case "coinbase_fetchPermissions": {
				...
				const requestedChainId = hexToNumber$1(completeRequest.params?.[0].chainId);
	...
	*/
	...
	async sendRequestToSubAccountSigner(request) {
		...
		const chainId = walletSendCallsChainId ? hexToNumber$1(walletSendCallsChainId) : this.chain.id;
