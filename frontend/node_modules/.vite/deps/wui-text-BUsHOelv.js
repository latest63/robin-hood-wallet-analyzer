import { a as nothing, c as notEqual, i as noChange, l as css, n as _$LH, r as html, s as defaultConverter, t as LitElement } from "./lit-B_-YxJix.js";
import { a as resetStyles, n as colorStyles, r as elementStyles } from "./ConstantsUtil-BZ5rPjcY.js";
...
var ICONS = {
	add: async () => (await import("./add-CojVPJbo.js")).addSvg,
	allWallets: async () => (await import("./all-wallets-BiMsPeuz.js")).allWalletsSvg,
	arrowBottomCircle: async () => (await import("./arrow-bottom-circle-5SPnD8Q_.js")).arrowBottomCircleSvg,
	appStore: async () => (await import("./app-store-CxGTyiaa.js")).appStoreSvg,
	apple: async () => (await import("./apple-B8Enn7oQ.js")).appleSvg,
	arrowBottom: async () => (await import("./arrow-bottom-me-rpQmz.js")).arrowBottomSvg,
	arrowLeft: async () => (await import("./arrow-left-BkqALNNr.js")).arrowLeftSvg,
	arrowRight: async () => (await import("./arrow-right-ex4wvKTO.js")).arrowRightSvg,
	arrowTop: async () => (await import("./arrow-top-CxCJ-GkM.js")).arrowTopSvg,
	bank: async () => (await import("./bank-DJtTykIF.js")).bankSvg,
	browser: async () => (await import("./browser-D29dc-eB.js")).browserSvg,
	card: async () => (await import("./card-DG6U4fjv.js")).cardSvg,
	checkmark: async () => (await import("./checkmark-DRQQ71ms.js")).checkmarkSvg,
	checkmarkBold: async () => (await import("./checkmark-bold-DsNY3Xfk.js")).checkmarkBoldSvg,
	chevronBottom: async () => (await import("./chevron-bottom-CHjOdmgW.js")).chevronBottomSvg,
	chevronLeft: async () => (await import("./chevron-left-CxXeeK_r.js")).chevronLeftSvg,
	chevronRight: async () => (await import("./chevron-right-BNZWPNAZ.js")).chevronRightSvg,
	chevronTop: async () => (await import("./chevron-top-BpTXY1kg.js")).chevronTopSvg,
	chromeStore: async () => (await import("./chrome-store-DOSqoqFg.js")).chromeStoreSvg,
	clock: async () => (await import("./clock-Cgqa5T8g.js")).clockSvg,
	close: async () => (await import("./close-BYKrp_qU.js")).closeSvg,
	compass: async () => (await import("./compass-IID7iCeY.js")).compassSvg,
	coinPlaceholder: async () => (await import("./coinPlaceholder-yPBeKk0v.js")).coinPlaceholderSvg,
	copy: async () => (await import("./copy-Cb76b8Nf.js")).copySvg,
	cursor: async () => (await import("./cursor-DKw7IM9O.js")).cursorSvg,
	cursorTransparent: async () => (await import("./cursor-transparent-B22PMst5.js")).cursorTransparentSvg,
	desktop: async () => (await import("./desktop-BnlfN4h0.js")).desktopSvg,
	disconnect: async () => (await import("./disconnect-CozH8zqj.js")).disconnectSvg,
	discord: async () => (await import("./discord-BMmX6P3j.js")).discordSvg,
	etherscan: async () => (await import("./etherscan-B-smS_XO.js")).etherscanSvg,
	extension: async () => (await import("./extension-C0yCiSXw.js")).extensionSvg,
	externalLink: async () => (await import("./external-link-ECk0iTLZ.js")).externalLinkSvg,
	facebook: async () => (await import("./facebook-CihbG1bk.js")).facebookSvg,
	farcaster: async () => (await import("./farcaster-CzA21e-k.js")).farcasterSvg,
	filters: async () => (await import("./filters-CGUtWlR_.js")).filtersSvg,
	github: async () => (await import("./github-QZQjALqm.js")).githubSvg,
	google: async () => (await import("./google-zfvZTsEm.js")).googleSvg,
	helpCircle: async () => (await import("./help-circle-DFIEXCOv.js")).helpCircleSvg,
	image: async () => (await import("./image-DA-GsX1l.js")).imageSvg,
	id: async () => (await import("./id-rAtggsas.js")).idSvg,
	infoCircle: async () => (await import("./info-circle-Dw0r0clt.js")).infoCircleSvg,
	lightbulb: async () => (await import("./lightbulb-C0JY-Eh4.js")).lightbulbSvg,
	mail: async () => (await import("./mail-8Kpcv4rw.js")).mailSvg,
	mobile: async () => (await import("./mobile-Cnvxl2ak.js")).mobileSvg,
	more: async () => (await import("./more-BWuJ2aNX.js")).moreSvg,
	networkPlaceholder: async () => (await import("./network-placeholder-ir4D8nf2.js")).networkPlaceholderSvg,
	nftPlaceholder: async () => (await import("./nftPlaceholder-OIEpeGfD.js")).nftPlaceholderSvg,
	off: async () => (await import("./off-CShOYVpp.js")).offSvg,
	playStore: async () => (await import("./play-store-BZGAfDaS.js")).playStoreSvg,
	plus: async () => (await import("./plus-cghRav6o.js")).plusSvg,
	qrCode: async () => (await import("./qr-code-Pcn4VdGg.js")).qrCodeIcon,
	recycleHorizontal: async () => (await import("./recycle-horizontal-vX9BxeFc.js")).recycleHorizontalSvg,
	refresh: async () => (await import("./refresh-N7gkZkwQ.js")).refreshSvg,
	search: async () => (await import("./search-AcCfGbb7.js")).searchSvg,
	send: async () => (await import("./send-BXBwr-5J.js")).sendSvg,
	swapHorizontal: async () => (await import("./swapHorizontal-CZP_3-V7.js")).swapHorizontalSvg,
	swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-nOALn-l5.js")).swapHorizontalMediumSvg,
	swapHorizontalBold: async () => (await import("./swapHorizontalBold-ZfwjKKae.js")).swapHorizontalBoldSvg,
	swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-D2SxM2hU.js")).swapHorizontalRoundedBoldSvg,
	swapVertical: async () => (await import("./swapVertical-CEqtWpao.js")).swapVerticalSvg,
	telegram: async () => (await import("./telegram-BtCqe-fA.js")).telegramSvg,
	threeDots: async () => (await import("./three-dots-PtLPYg3k.js")).threeDotsSvg,
	twitch: async () => (await import("./twitch-DPlqEV1a.js")).twitchSvg,
	twitter: async () => (await import("./x-DWz8P94M.js")).xSvg,
	twitterIcon: async () => (await import("./twitterIcon-BhdmQF9U.js")).twitterIconSvg,
	verify: async () => (await import("./verify-D7lZKNH7.js")).verifySvg,
	verifyFilled: async () => (await import("./verify-filled-Bm63wH1z.js")).verifyFilledSvg,
	wallet: async () => (await import("./wallet-BJa5Gbwr.js")).walletSvg,
	walletConnect: async () => (await import("./walletconnect-DGaeQI1x.js")).walletConnectSvg,
	walletConnectLightBrown: async () => (await import("./walletconnect-DGaeQI1x.js")).walletConnectLightBrownSvg,
	walletConnectBrown: async () => (await import("./walletconnect-DGaeQI1x.js")).walletConnectBrownSvg,
	walletPlaceholder: async () => (await import("./wallet-placeholder-CukQ-ZcM.js")).walletPlaceholderSvg,
	warningCircle: async () => (await import("./warning-circle-DzaFdYRI.js")).warningCircleSvg,
	x: async () => (await import("./x-DWz8P94M.js")).xSvg,
	info: async () => (await import("./info-Cyg5U7hq.js")).infoSvg,
	exclamationTriangle: async () => (await import("./exclamation-triangle-DlFR101V.js")).exclamationTriangleSvg,
	reown: async () => (await import("./reown-logo-CS10FZtc.js")).reownSvg
};
...
//#endregion
export { customElement as a, property as c, ifDefined as i, AsyncDirective as n, UiHelperUtil as o, directive as r, state as s, classMap as t };
